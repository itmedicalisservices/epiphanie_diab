...
$e = $this->md_patient->cas_deces($id);
	...
	<body style="font-family:verdana">
		<div style="padding:10px 30px 0px 30px" >
			...
			<table style="width:100%; font-size:12px">
				<tr> 
					<td style="font-size:25px; height:20px; font-weight:bold" align="center">Déclaration de décès</td>
				</tr>
			...
			<table style="width:100%; font-size:12px" border="1" cellspacing="0">
				...
				<tbody class="corps">
					<tr style="height:30px">  
						<td><?php echo $this->md_config->affDateFrNum($e->dec_dDateDeces); ?></td>
						<td><?php echo $e->dec_tHeureDeces; ?></td>
						<td><?php echo $e->uni_sLibelle; ?></td>
						<td><?php echo $e->dec_sCause; ?></td>
					</tr>				
				</tbody>
			</table>
