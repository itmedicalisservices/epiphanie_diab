				...
				<tr>
					...
					<td style="width:100%;">
						<table style="width:100%;" align="right">
							<tr><td colspan="2" style="font-size:20pt;font-weight:500;padding-top:40px" align="center">Fiche 3 d'examen échographique</td></tr>
							<tr>
						...
						<table class="table" style="width:100%;padding-top:150px;clear:both;" align="right" cellspacing="0">
							<thead style="paddind:50px;" align="left">
								<tr style="height:25px;">
									<td colspan="4">
										<h2 style="font-size:15px;">Autres</h2>
										<ul><li><span style="font-weight:bold">Ovaires</span></li></ul>
									</td>
								</tr>
								
								<tr style="height:25px;" align="center">
									<th style="border:1px solid #000">Ovaire droit</th>
									<th style="border:1px solid #000">Grand axe ovaire droit</th>
									<th style="border:1px solid #000">Ovaire gauche</th>
									<th style="border:1px solid #000">Grand axe ovaire gauche</th>
								</tr>
							</thead>
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$echographie->eec_sOvaireDroit ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$echographie->eec_sOvaireDroitGrand . ' mm';?></td>
									<td style="border:1px solid #000;" align="center"><?=$echographie->eec_sOvaireGauche ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$echographie->eec_sOvaireGaucheGrand . ' mm';?></td>
								</tr>
							</tbody>
						</table>
						<table class="table" style="width:100%;padding-top:275px;clear:both;" align="right" cellspacing="0">
							<thead style="paddind:50px;" align="left">
								<tr style="height:25px;">
									<td colspan="2"><ul><li><span style="font-weight:bold">Culs de sac</span></li></ul></td>
								</tr>
								<tr style="height:25px;" align="center">
									<th style="border:1px solid #000">Culs de sac latéraux</th>
									<th style="border:1px solid #000">Douglas</th>
								</tr>
							</thead>
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000"><?=$echographie->eec_sCul;?></td>
									<td style="border:1px solid #000;" align="center"><?=$echographie->eec_sDouglas ;?></td>
								</tr>
							</tbody>
						</table>
						<table class="table" style="width:100%;padding-top:375px;clear:both;" align="right" cellspacing="0">
							<thead style="paddind:50px;" align="left">
								<tr style="height:25px;">
									<td colspan="4"><ul><li><span style="font-weight:bold">Doppler A. utérines</span></li></ul></td>
								</tr>
								<tr style="height:25px;" align="center">
									<th style="border:1px solid #000">AUD IR</th>
									<th style="border:1px solid #000">AUD IP</th>
									<th style="border:1px solid #000">AUG IR</th>
									<th style="border:1px solid #000">AUG IP</th>
								</tr>
							</thead>
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000"><?=$echographie->eec_sAudir;?></td>
									<td style="border:1px solid #000;" align="center"><?=$echographie->eec_sAudip ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$echographie->eec_sAugir ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$echographie->eec_sAugip ;?></td>
								</tr>
							</tbody>
						</table>
						<table class="table" style="width:100%;padding-top:475px;clear:both;" align="right" cellspacing="0">
							<thead style="paddind:50px;" align="left">
								<tr style="height:25px;">
									<td colspan="1"><ul><li><span style="font-weight:bold">Trompes</span></li></ul></td>
								</tr>
								<tr style="height:25px;" align="center">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000"><?=$echographie->eec_sTrompes;?></td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table" style="width:100%;padding-top:575px;clear:both;" align="right" cellspacing="0">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$echographie->eec_sConclusion ;?></td>
								</tr>
							</tbody>
						</table>
