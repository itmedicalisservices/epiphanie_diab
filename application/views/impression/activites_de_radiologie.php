...
?>
<pre><?php $listeACteRad = $this->md_parametre->liste_acts_radiologie_actifs(); //print_r($listeACteRad);?></pre>
<pre><?php //$nb = $this->md_parametre->nb_examen_imagerie(); print_r($nb);?></pre>
	...
	<body style="font-family:verdana">
		<div style="width:100%;padding:10px 2px 0px 2px" >
		 ...
		 <!-- Corps de reçu -->
			<table style="width:100%; font-size:12px">
				<tr> 
					<td style="font-size:15px; height:16px; font-weight:bold" align="center">2.5 ACTIVITES DE RADIOLOGIE</td>
				</tr>
			</table>
			<br>
			<table style="width:100%; font-size:12px" border="1" cellspacing="0">
				<thead>
					<tr> 
						<th style="font-size:12px;">N° d'ordre (1)</th>
				...
				<tbody class="corps">
					...
					<?php $nbExaMed = $this->md_parametre->nb_examen_imagerie($l->lac_id,$premier,$dernier); $nbExaMed->nb;?>
					...
					<tr> 
						...
						<td style="font-size:11.5px;" align="center"><?php $nbExaMed = $this->md_parametre->nb_examen_imagerie($l->lac_id,$premier,$dernier); echo $nbExaMed->nb; ?></td>
			...
			<table style="width:100%; margin-top:30px; font-size:12px">
				...
				<tr> 
					<td style="width:20%"><b>Colonne 2</b> : Inscrire le type d'examens réalisés (Thorax, des OS, ASP)</td>
				</tr>
				<tr> 
					<td style="width:20%"><b>Colonne 3</b> : Indiquer le nombre d'examens réalisés par type de structure.</td>
				</tr>
				<tr> 
