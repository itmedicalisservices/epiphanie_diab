...
$liste = $this->md_patient->liste_hospitalisation1($premier,$dernier); 
	...
	<body style="font-family:verdana">
		<div style="width:100%;padding:10px 2px 0px 2px" >
		 ...
		 <!-- Corps de reçu -->
			<table style="width:100%; font-size:12px">
				<tr> 
					<td style="font-size:15px; height:16px; font-weight:bold" align="center">1.2 REPARTITION DES MALADES HOSPITALISES</td>
				</tr>
			</table>
			<br>
			<table style="width:100%; font-size:12px" border="1" cellspacing="0">
				<thead>
					<tr> 
						...
						<th style="font-size:12px;" rowspan="4">Causes d'hospitalisation (2)</th>
				...
				<tbody class="corps">
					...
					<tr> 
						...
						<td style="font-size:11.5px;"><?php echo $l->hos_sMotif?></td>
						<td style="font-size:11.5px;background:rgb(255,149,149)" align="center"></td>
						<td style="font-size:11.5px;" align="center"><?php $chmoisun = $this->md_patient->repartition_malades_hospitalise_moins_1_cas_homme($l->hos_sMotif,$moinsun); echo $chmoisun->nb; $som_1=$som_1+$chmoisun->nb; ?></td>
						<td style="font-size:11.5px;" align="center"><?php $cfmoisun = $this->md_patient->repartition_malades_hospitalise_moins_1_cas_femme($l->hos_sMotif,$moinsun); echo $cfmoisun->nb; $som_2=$som_2+$cfmoisun->nb; ?></td>
						<td style="font-size:11.5px;" align="center"><?php $dhmoisun = $this->md_patient->repartition_malades_hospitalise_moins_1_deces_homme($l->hos_sMotif,$moinsun); echo $dhmoisun->nb; $som_3=$som_3+$dhmoisun->nb; ?></td>
						<td style="font-size:11.5px;" align="center"><?php $dfmoisun = $this->md_patient->repartition_malades_hospitalise_moins_1_deces_femme($l->hos_sMotif,$moinsun); echo $dfmoisun->nb; $som_4=$som_4+$dfmoisun->nb; ?></td>
						<td style="font-size:11.5px;" align="center"><?php $ch14 = $this->md_patient->repartition_malades_hospitalise_1_a_49_cas_homme($l->hos_sMotif,$m14,$moinsun); echo $ch14->nb; $som_5=$som_5+$ch14->nb; ?></td>
						<td style="font-size:11.5px;" align="center"><?php $cf14 = $this->md_patient->repartition_malades_hospitalise_1_a_49_cas_femme($l->hos_sMotif,$m14,$moinsun); echo $cf14->nb;$som_6=$som_6+$cf14->nb; ?></td>
						<td style="font-size:11.5px;" align="center"><?php $dh14 = $this->md_patient->repartition_malades_hospitalise_1_a_49_deces_homme($l->hos_sMotif,$m14,$moinsun); echo $dh14->nb;$som_7=$som_7+$dh14->nb; ?></td>
						<td style="font-size:11.5px;" align="center"><?php $df14 = $this->md_patient->repartition_malades_hospitalise_1_a_49_deces_femme($l->hos_sMotif,$m14,$moinsun); echo $df14->nb;$som_8=$som_8+$df14->nb; ?></td>
						<td style="font-size:11.5px;" align="center"><?php $ch514 = $this->md_patient->repartition_malades_hospitalise_1_a_49_cas_homme($l->hos_sMotif,$m514,$m14 ); echo $ch514->nb;$som_9=$som_9+$ch514->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $cf514 = $this->md_patient->repartition_malades_hospitalise_1_a_49_cas_femme($l->hos_sMotif,$m514,$m14 ); echo $cf514->nb;$som_10=$som_10+$cf514->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $dh514 = $this->md_patient->repartition_malades_hospitalise_1_a_49_deces_homme($l->hos_sMotif,$m514,$m14 ); echo $dh514->nb;$som_11=$som_11+$dh514->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $df514 = $this->md_patient->repartition_malades_hospitalise_1_a_49_deces_femme($l->hos_sMotif,$m514,$m14 ); echo $df514->nb;$som_12=$som_12+$df514->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $ch1549 = $this->md_patient->repartition_malades_hospitalise_1_a_49_cas_homme($l->hos_sMotif,$m1549,$m514); echo $ch1549->nb;$som_13=$som_13+$ch1549->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $cf1549 = $this->md_patient->repartition_malades_hospitalise_1_a_49_cas_femme($l->hos_sMotif,$m1549,$m514); echo $cf1549->nb;$som_14=$som_14+$cf1549->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $dh1549 = $this->md_patient->repartition_malades_hospitalise_1_a_49_deces_homme($l->hos_sMotif,$m1549,$m514); echo $dh1549->nb;$som_15=$som_15+$dh1549->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $df1549 = $this->md_patient->repartition_malades_hospitalise_1_a_49_deces_femme($l->hos_sMotif,$m1549,$m514); echo $df1549->nb;$som_16=$som_16+$df1549->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $ch50plus = $this->md_patient->repartition_malades_hospitalise_50_et_plus_cas_homme($l->hos_sMotif,$m50plus); echo $ch50plus->nb;$som_17=$som_17+$ch50plus->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $cf50plus = $this->md_patient->repartition_malades_hospitalise_50_et_plus_cas_femme($l->hos_sMotif,$m50plus); echo $cf50plus->nb;$som_18=$som_18+$cf50plus->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $dh50plus = $this->md_patient->repartition_malades_hospitalise_50_et_plus_deces_homme($l->hos_sMotif,$m50plus); echo $dh50plus->nb;$som_19=$som_19+$dh50plus->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $df50plus = $this->md_patient->repartition_malades_hospitalise_50_et_plus_deces_femme($l->hos_sMotif,$m50plus); echo $df50plus->nb;$som_20=$som_20+$df50plus->nb;?></td>
			...
			<table style="width:100%; margin-top:30px; font-size:12px">
				...
				<tr> 
					...
					<td style="">Inscrire les causes d'hospitalisation.</td>
				</tr>
				<tr> 
				...
				<tr> 
					...
					<td style="">Inscrire dans les sous colonnes le nombre de cas et de décès enregistrés selon les causes d'hospitalisation, la tranche d'âge et le sexe.</td>
				</tr>
				<tr> 
					<td style="font-weight:bold;width:80px">Colonne 5 : </td>
					<td style="">Inscrire le total des cas et des décès enregistrés selon les causes d'hospitalisation, toutes tranches d'âge et sexe confondus.</td>
				</tr>
				<tr> 
