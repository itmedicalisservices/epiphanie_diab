...
$gyneco_obs_d = $this->md_patient->gyneco_d($id);
$patient = $this->md_patient->acm_patient($gyneco_obs_d->acm_id);
$medecin = $this->md_personnel->recup_personnel($gyneco_obs_d->per_id);
$per = $this->md_personnel->liste_personnel_medical(7,1);
// var_dump($gyneco_obs_d, $patient, $medecin);
// die();
?>
				...
				<tr>
					...
					<td style="width:100%;margin-bottom:-150px;">
						...
						<table class="table" style="width:100%;padding-top:175px;margin-bottom:100px;clear:both;" align="right" cellspacing="0">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sIndication;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sVoie;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sCondition;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_iNfoetus;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sType;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sMembrane;?></td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table" style="width:100%;padding-top:255px;clear:both;" align="right" cellspacing="0">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sPresentation ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sActCardiaque ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_iRcf . ' bpm';?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sMaf ;?></td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table" style="width:100%;padding-top:375px;clear:both;" align="right" cellspacing="0">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_iBip . ' mm';?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_iPc . ' mm';?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_iPa . ' mm';?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_iFemur . ' mm' ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_iPoids ;?></td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table" style="width:100%;padding-top:475px;clear:both;" align="right" cellspacing="0">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sMorpho ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sOge ;?></td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table" style="width:100%;padding-top:575px;clear:both;" align="right" cellspacing="0">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sLiquide ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_iPgc . ' mm';?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sPlacenta ;?></td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table" style="width:100%;padding-top:675px;clear:both;" align="right" cellspacing="0">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sDopIR ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sDopFlux ;?></td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table" style="width:100%;padding-top:775px;clear:both;" align="right" cellspacing="0">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sAcmIR ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_iDopAcmVitesse . ' cm/s';?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sDopAcmMOM ;?></td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table" style="width:100%;padding-top:875px;clear:both;" align="right" cellspacing="0">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sDopArantiusIR ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sDopArantiusOnde ;?></td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table" style="width:100%;padding-top:975px;clear:both" align="right" cellspacing="0">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sDopUterinDtIR ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sDopUterinDtNotch ;?></td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table" style="width:100%;padding-top:1075px;clear:both;" align="right" cellspacing="0">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sDopUterinGIR ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sDopUterinGNotch ;?></td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table" style="width:100%;padding-top:1150px;clear:both;" align="right" cellspacing="0">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_iColLongueur ;?></td>
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sColEntonnoir ;?></td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table" style="width:100%;padding-top:1300px;clear:both;" align="right" cellspacing="0">
							...
							<tbody>
								<tr style="height:50px;">  
									<td style="border:1px solid #000;" align="center"><?=$gyneco_obs_d->god_sConclusion ;?></td>
								</tr>
							</tbody>
						</table>
