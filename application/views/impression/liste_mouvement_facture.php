...
$liste = $this->md_patient->liste_mouvement_caisse_facture($id, $date1, $date2, $acte, $typemvt);
	...
	<body >
		...
		<div style="padding:25px 20px 0px 20px" class="recu">
			...
			<div style="" class="recu">
				...
				<table style="width:100%; height:2px;">
					<tr>
						<td  align="center" ><span style="font-weight:bold;font-size:14pt;text-decoration:underline"><?php echo $libelle;?></span></td>
					</tr>
				</table>				
				<table style="width:100%; height:2px;">
					<tr>
				...
				<table class="list" style="width:100%;" >
					...
					<?php $annulation = $this->md_parametre->recup_liste_annulation_caissier($user->per_id, $date1, $date2);?>
					...
					<?php $cession = $this->md_parametre->recup_liste_cession_caissier($user->per_id, $date1, $date2);?>
					<?php $passation = $this->md_parametre->recup_liste_passation_caissier($user->per_id, $date1, $date2);?>
				...
				<table style="width:100%;margin-top:20px">
					<tr>
						<td style="width:50%;font-weight:bold;font-size:7pt"><span style="font-weight:bold;margin-left:40px"><?php if($user->per_sSexe=='H'){echo 'CAISSIER';}else{echo 'CAISSIERE';};?>:</span></br></br></br></br><span style="margin-left:40px"> <?php echo $user->per_sNom . ' ' . $user->per_sPrenom; ?></span></td>
