...
$element = $this->md_patient->imagerie_sejour($id); 
$elmt = $this->md_patient->acte_imagerie_sejour($element->img_id);
foreach ($elmt as $e) {
	$patient = $this->md_patient->recup_patient($e->pat_id);
}
$per = $this->md_personnel->liste_personnel_medical(7,1);
// $med2 = $this->md_patient->medecin_prescripteur_imagerie($id);
				...
				<tr>
					...
					<td style="width:100%;">
						<table style="width:100%;" align="right">
							<tr><td align="right" colspan="2">Brazzaville, <?php echo $this->md_config->affDateTimeFr($element->img_dDate); ?></td></tr>
							<tr><td colspan="2" style="font-size:20pt;font-weight:500;padding-top:40px" align="center">Prescription en imagerie</td></tr>
							<tr>
								<td style="font-weight:bold;padding-top:40px"><?php echo $patient->pat_sCivilite .' '.$patient->pat_sNom .' '. $patient->pat_sPrenom; ?></td>
						...
						<table style="width:100%;padding-top:230px;clear:both" align="right" cellspacing="0">
							...
							<?php } ?>
							<?php if(!empty($element->img_sDescription)){ ?>
							...
							<tbody >
								<tr><td><?php echo $element->img_sDescription; ?></td></tr>
							</tbody>
							<?php } ?>
						</table>
					</td>
