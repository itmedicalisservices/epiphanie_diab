...
$elt = $this->md_patient->nouveau_sejour($id);

?>
<!DOCTYPE html>
<html>
	<head>
		<title>Déclaration nouveau né</title>
		<meta charset="UTF-8">
		<style>
	...
	<body style="font-family:verdana">
		<div style="padding:10px 30px 0px 30px" >
			...
			<table style="width:100%; font-size:12px">
				<tr> 
					<td style="font-size:25px; height:20px; font-weight:bold" align="center">Déclaration nouveau né</td>
				</tr>
			...
			<table style="width:100%; font-size:12px" border="1" cellspacing="0">
				...
				<?php foreach($elt AS $e){ ?>
					<tr style="height:30px">  
						<td><?php echo $this->md_config->affDateFrNum($e->nne_dDateNaiss); ?></td>
						<td><?php echo $e->nne_tHeureNaiss; ?></td>
						<td><?php echo $e->nne_sSexe; ?></td>
					</tr>
				<?php } ?>
				</tbody>
			</table>
