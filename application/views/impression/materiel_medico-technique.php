	...
	<body style="font-family:verdana">
		<div style="width:100%;padding:10px 2px 0px 2px" >
		 ...
		 <!-- Corps de reçu -->
			<table style="width:100%; font-size:12px">
				<tr> 
					<td style="font-size:15px; height:16px; font-weight:bold" align="center">7.2- MATERIEL MEDICO-TECHNIQUE</td> 
				</tr>
			</table>
			<br>
			<table style="width:100%; font-size:12px" border="1" cellspacing="0">
				<thead>
					<tr> 
						...
						<th style="font-size:12px;" colspan="3">Quantité</th>
						<th style="font-size:12px;" rowspan="2">Total</th>
					</tr>
					<tr> 
						<th style="font-size:12px;">Bon</th>
						<th style="font-size:12px;">En panne</th>
						<th style="font-size:12px;">Hors d'usage</th>
					</tr>
				</thead>
