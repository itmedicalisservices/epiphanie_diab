...
<?php 
	...
	$acte = $this->md_patient->montant_par_acte($delai,$fait);
 ?>
					...
					<div class="body">
						<form id="stat-caisse">
							<div class="row clearfix">
								...
								<div class="col-sm-2">
								<br><br>
									<button type="submit" class="btn btn-raised bg-blue-grey" id="parActeDansDir">Valider</button>
								</div>
							</div>
						</form>
					</div>
