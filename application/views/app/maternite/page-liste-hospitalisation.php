...
<?php 
	...
	$listeEncours = $this->md_patient->liste_patient_materne();
            ...
            <div role="tabpanel" class="tab-pane active in" id="income">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="card">
							<div class="header">
								<h2>Liste des patients maternés</h2>
							</div>
										...
										<tr>
											...
											<td class="text-center">
												<?php if($user->per_iTypeCompte!=5){ ?>
													<a href="<?php echo site_url("hospitalisation/patient_materne/".$le->hos_id); ?>"><b><i class="fa fa-bed" style="font-size:23px"></i><br>Consulter</b></a>
												<?php }else{ ?>
