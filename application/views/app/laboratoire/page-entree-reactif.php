...
<?php $liste = $this->md_parametre->liste_reactif_actifs(); ?>
<?php $listeEntreeRea = $this->md_parametre->liste_entree_reactif(); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">Inventaire des réactif </h2><button style="" type="button" class="btn bg-blue-grey waves-effect ajout_service pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter une nouvelle</b></button>
						<?php //var_dump($listeEntreeRea) ;?>
					</div>
                    <div class="body table-responsive"> 
						<table id="example" class="table table-bordered table-striped table-hover">
							...
							<tbody>
							<?php foreach($listeEntreeRea AS $l){ ?>
								<tr>									
									<td>
									...
									<td>
										<?php echo $l->ere_iSeuil ;?>
									</td>
									<td>
										<?php echo $this->md_config->affDateFrNum($l->ere_dDate) ;?>
									</td>
								</tr>
							<?php } ?>
							</tbody>
