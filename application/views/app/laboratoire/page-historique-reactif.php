...
<?php $liste = $this->md_parametre->liste_historique_reactif(); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">Historique des entrées des réactifs </h2>
						<?php //var_dump($liste) ;?>
					</div>
						...
						<table id="example" class="table table-bordered table-striped table-hover">
							...
							<?php foreach($liste AS $l){ ?>
								<tr>									
									...
									<td>
										<?php echo $this->md_config->affDateFrNum($l->hre_dDateEntree) ;?>
									</td>
								</tr>
							<?php } ?>
							</tbody>
