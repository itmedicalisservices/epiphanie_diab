                ...
                <div class="card">
                    <div class="body"> 
						...
						<ul class="nav nav-tabs" role="tablist" style="font-size:13.5px;border-bottom:none">
                            ...
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#traitemnet"><b>Traitement dentaire</b></a></li>
                        </ul>
                        ...
                        <div class="tab-content">
							...
							<div role="tabpanel" class="tab-pane" id="consultation">
								...
								<div class="body">
									...
									<div class="row clearfix">
											...
											<div class="panel-group" id="accordion_1" role="tablist" aria-multiselectable="true">
												<div class="panel panel-primary">
													<div class="panel-heading" role="tab" id="headingThree_1">
														<h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_1" href="#collapseEleven_1" aria-expanded="false"
																   aria-controls="collapseEleven_1"><strong> Motif de la consultation</strong> </a> </h4>
													</div>
														...
														<div class="panel-body"> 
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
																		<div class="form-line">
																		<label style="color:#000">Motif *</label>
																			<textarea class="form-control obligatoire" rows="10" name="motif"></textarea>
																		</div>
																	</div>
																</div>																																																										
																<div class="col-sm-12">
																	<div class="form-group">
																		<div class="form-line">
																		<label style="color:#000">Antécédents stomatologiques *</label>
																			<textarea class="form-control obligatoire" rows="10" name="antecedent"></textarea>
																		</div>
																	</div>
																</div>																																																										
																<div class="col-sm-12">
																	<div class="form-group">
																		<div class="form-line">
																		<label style="color:#000">Complement d'amnanèse *</label>
																			<textarea class="form-control obligatoire" rows="10" name="complement"></textarea>
																		</div>
																	</div>
																</div>																																																										
															</div>																																																																							
												...
												<div class="panel panel-primary">
													<div class="panel-heading" role="tab" id="headingThree_1">
														<h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_1" href="#collapseTwenty_1" aria-expanded="false"
																   aria-controls="collapseTwenty_1"><strong> Examen clinique</strong> </a> </h4>
													</div>
													<div id="collapseTwenty_1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree_1">
														<div class="panel-body"> 
															<div class="col-sm-12">
																<strong style="color:#000">Examen exobucal</strong>
															</div>	
															<div class="col-sm-12">
																<div class="form-group">
																	<div class="form-line">
																	<label style="color:#000">Description *</label>
																		<textarea class="form-control obligatoire" rows="10" name="desc"></textarea>
																	</div>
																</div>
															</div>
															<div class="col-sm-12">
																<strong style="color:#607d8b">Examen endobucal</strong>
															</div>
															<div class="row">
																<div class="col-sm-6">
																	<div class="form-group">
																		<div class="form-line">
																		<label style="color:#000">Ouverture buccale *</label>
																			<select name="ouverture" class="form-control obligatoire">
																				<option value="1 traver">1 traver</option>
																				<option value="2 travers">2 travers</option>
																				<option value="3 travers">3 travers</option>
																			</select>
																		</div>
																	</div>
																</div>															
																<div class="col-sm-6">
																	<div class="form-group">
																		<div class="form-line">
																		<label style="color:#000">Hygiène buccale *</label>
																			<select name="hygiene" class="form-control obligatoire">
																				<option value="Bonne">Bonne</option>
																				<option value="Plus ou moins Bonne">Plus ou moins Bonne</option>
															...
															<div class="col-sm-12">
																<strong style="color:#607d8b">Examen dentaire</strong>
															</div>															
															<div class="col-sm-12">
																<div class="form-group">
																	<div class="form-line">
																		<strong> Insicives supérieures</strong><br>
																		<input type="checkbox" id="checkbox_1" name="dent[]" value="131-/-Insicives supérieures-/-centrale 1">
																		<label for="checkbox_1"> centrale 1</label>
																		<input type="checkbox" id="checkbox_2" name="dent[]" value="131-/-Insicives supérieures-/-centrale 2">
																		<label for="checkbox_2"> centrale 2</label>
																		<input type="checkbox" id="checkbox_3" name="dent[]" value="131-/-Insicives supérieures-/-latérale 1">
																		<label for="checkbox_3"> latérale 1</label>
																		<input type="checkbox" id="checkbox_4" name="dent[]" value="131-/-Insicives supérieures-/-latérale 2">
																		<label for="checkbox_4"> latérale 2</label><br>
																		
																		<strong> Insicives inférieures</strong><br>
																		<input type="checkbox" id="checkbox_5" name="dent[]" value="131-/-Insicives inférieures-/-centrale 1">
																		<label for="checkbox_5"> centrale 1</label>
																		<input type="checkbox" id="checkbox_6" name="dent[]" value="131-/-Insicives inférieures-/-centrale 2">
																		<label for="checkbox_6"> centrale 2</label>
																		<input type="checkbox" id="checkbox_7" name="dent[]" value="131-/-Insicives inférieures-/-latérale 1">
																		<label for="checkbox_7"> latérale 1</label>
																		<input type="checkbox" id="checkbox_8" name="dent[]" value="131-/-Insicives inférieures-/-latérale 2">
																		<label for="checkbox_8"> latérale 2</label>
																	</div>
																</div>
															</div>															
															<div class="col-sm-12">
																<div class="form-group">
																	<div class="form-line">
																		<strong> Canines supérieures</strong><br>
																		<input type="checkbox" id="checkbox_9" name="dent[]" value="132-/-Canines supérieures-/-canine gauche">
																		<label for="checkbox_9"> canine gauche</label>
																		<input type="checkbox" id="checkbox_10" name="dent[]" value="132-/-Canines supérieures-/-canine droite">
																		<label for="checkbox_10"> canine droite</label><br>
																		
																		<strong> Canines inférieures</strong><br>
																		<input type="checkbox" id="checkbox_11" name="dent[]" value="132-/-Canines inférieures-/-canine gauche">
																		<label for="checkbox_11"> canine gauche</label>
																		<input type="checkbox" id="checkbox_12" name="dent[]" value="132-/-Canines inférieures-/-canine gauche">
																		<label for="checkbox_12"> canine droite</label>
																	</div>
																</div>
															</div>	
															<div class="col-sm-12">
																<div class="form-group">
																	<div class="form-line">
																		<strong> Prémolaires supérieures</strong><br>
																		<input type="checkbox" id="checkbox_13" name="dent[]" value="133-/-Prémolaires supérieures-/-centrale 1">
																		<label for="checkbox_13"> centrale 1</label>
																		<input type="checkbox" id="checkbox_14" name="dent[]" value="133-/-Prémolaires supérieures-/-centrale 2">
																		<label for="checkbox_14"> centrale 2</label>
																		<input type="checkbox" id="checkbox_15" name="dent[]" value="133-/-Prémolaires supérieures-/-latérale 1">
																		<label for="checkbox_15"> latérale 1</label>
																		<input type="checkbox" id="checkbox_16" name="dent[]" value="133-/-Prémolaires supérieures-/-latérale 1">
																		<label for="checkbox_16"> latérale 2</label><br>
																		
																		<strong> Prémolaires inférieures</strong><br>
																		<input type="checkbox" id="checkbox_17" name="dent[]" value="133-/-Prémolaires inférieures-/-centrale 1">
																		<label for="checkbox_17"> centrale 1</label>
																		<input type="checkbox" id="checkbox_18" name="dent[]" value="133-/-Prémolaires inférieures-/-centrale 2">
																		<label for="checkbox_18"> centrale 2</label>
																		<input type="checkbox" id="checkbox_19" name="dent[]" value="133-/-Prémolaires inférieures-/-latérale 1">
																		<label for="checkbox_19"> latérale 1</label>
																		<input type="checkbox" id="checkbox_20" name="dent[]" value="133-/-Prémolaires inférieures-/-latérale 2">
																		<label for="checkbox_20"> latérale 2</label>
																	</div>
																</div>
															</div>															
															<div class="col-sm-12">
																<div class="form-group">
																	<div class="form-line">
																		<strong> Molaires supérieures</strong><br>
																		<input type="checkbox" id="checkbox_21"  name="dent[]" value="134-/-Molaires supérieures-/-centrale 1">
																		<label for="checkbox_21"> centrale 1</label>
																		<input type="checkbox" id="checkbox_22" name="dent[]" value="134-/-Molaires supérieures-/-centrale 2">
																		<label for="checkbox_22"> centrale 2</label>
																		<input type="checkbox" id="checkbox_23" name="dent[]" value="134-/-Molaires supérieures-/-centrale 3">
																		<label for="checkbox_23"> centrale 1</label>
																		<input type="checkbox" id="checkbox_24" name="dent[]" value="134-/-Molaires supérieures-/-latérale 1">
																		<label for="checkbox_24"> centrale 2</label>
																		<input type="checkbox" id="checkbox_25" name="dent[]" value="134-/-Molaires supérieures-/-latérale 2">
																		<label for="checkbox_25"> latérale 1</label>
																		<input type="checkbox" id="checkbox_26" name="dent[]" value="134-/-Molaires supérieures-/-latérale 3">
																		<label for="checkbox_26"> latérale 2</label><br>
																		
																		<strong> Molaires inférieures</strong><br>
																		<input type="checkbox" id="checkbox_27" name="dent[]" value="134-/-Molaires inférieures-/-centrale 1">
																		<label for="checkbox_27"> centrale 1</label>
																		<input type="checkbox" id="checkbox_28" name="dent[]" value="134-/-Molaires inférieures-/-centrale 2">
																		<label for="checkbox_28"> centrale 2</label>
																		<input type="checkbox" id="checkbox_29" name="dent[]" value="134-/-Molaires inférieures-/-centrale 3">
																		<label for="checkbox_29"> centrale 1</label>
																		<input type="checkbox" id="checkbox_30" name="dent[]" value="134-/-Molaires inférieures-/-latérale 1">
																		<label for="checkbox_30"> centrale 2</label>
																		<input type="checkbox" id="checkbox_31" name="dent[]" value="134-/-Molaires inférieures-/-latérale 2">
																		<label for="checkbox_31"> latérale 1</label>
																		<input type="checkbox" id="checkbox_32" name="dent[]" value="134-/-Molaires inférieures-/-latérale 3">
																		<label for="checkbox_32"> latérale 2</label>
																		<input type="hidden" value="<?php echo $acm_id; ?>" name="id">
																		<input type="hidden" value="<?php echo $acm->pat_id; ?>" name="pat">
																	</div>
																</div>
										...
										<div class="row clearfix">
											<div class="col-sm-12">
												<a class="btn btn-raised bg-blue-grey" id="dentaire">Enregistrer</a>
											</div>
										</div>
									</form>
								</div>
							...
							<div role="tabpanel" class="tab-pane" id="traitemnet">
                                <div class="header" style="margin-top:45px">
									<h2>Traitement dentaire <small>renseignez tous les champs marqués par des (*)</small> </h2>
								</div>
