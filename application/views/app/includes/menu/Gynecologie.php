						<li class="<?php if ($page == "gynecologie") {
										echo "active";
									} ?>"><a href="javascript:void(0);" class="menu-toggle"><i class="fa fa-user-md"></i><span>Consultation</span> </a>
							<ul class="ml-menu">
								<!-- <li><a <?php if ($page == "gynecologie" and (!isset($sousPage) or $sousPage == "index")) {
												echo "style='color:#fff'";
											} ?> href="<?php echo site_url("gynecologie"); ?>">Patients orientés</a></li> -->
								<li><a <?php if ($page == "gynecologie" and $sousPage == "mes_patients") {
											echo "style='color:#fff'";
										} ?> href="<?php echo site_url("gynecologie/mes_patients"); ?>">Mes patients</a></li>
								<li><a <?php if ($page == "gynecologie" and $sousPage == "demande_avis") {
											echo "style='color:#fff'";
										} ?> href="<?php echo site_url("gynecologie/demande_avis"); ?>">Demande d'avis <span <?php if ($nb->nb != 0) {
								...
								<!--<li><a <?php /*if($page=="gynecologie" AND $sousPage=="hostirique_de_mes_patients"){echo "style='color:#fff'";} */ ?> href="<?php /*echo site_url("gynecologie/hostirique_de_mes_patients");*/ ?>">Mes dossiers patients</a></li>
                        <li><a <?php /*if($page=="gynecologie" AND $sousPage=="hostorique_actes"){echo "style='color:#fff'";} */ ?> href="<?php /*echo site_url("gynecologie/hostorique_actes");*/ ?>">Historique du service</a></li>-->
							</ul>
						</li>
