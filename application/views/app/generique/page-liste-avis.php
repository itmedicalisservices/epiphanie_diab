								...
								<table id="example1" class="table table-bordered table-striped table-hover">
									...
									<?php foreach($listeAvisEncours AS $le){ ?>
										<tr>
											...
											<td><?php echo $le->avs_dDate; ?></td>
											<td class="text-center">
												<a href="<?php echo site_url("consultation/faire/".$le->acm_id."/".$le->avis_id); ?>"><b><i class="fa fa-stethoscope" style="font-size:23px"></i><br>Consulter</b></a>
											</td>
										</tr>
									<?php } ?>
									</tbody>
