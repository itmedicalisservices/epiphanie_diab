									...
									<?php foreach($listeEncours AS $le){ ?>
										<tr>
											...
											<td class="text-center">
												<?php if($le->lac_id == 93){ ?>
												<a href="<?php echo site_url("gynecologie_obstetrique/faire/".$le->acm_id); ?>"><b><i class="fa fa-stethoscope" style="font-size:23px"></i><br>Consulter</b></a>
												<?php }else{ ?>
												<a href="<?php echo site_url("exploration/patient_en_examen/".$le->acm_id); ?>"><b>Donner les résultats</b></a>
												<?php } ?>
											</td>
										</tr>
									<?php } ?>
