...
<?php $liste = $this->md_patient->depot_objet(); ?>
						...
						<table id="example" class="table table-bordered table-striped table-hover">
							...
							<?php foreach($liste AS $l){ ?>
								<tr>
									...
									<td>
										<?php echo $l->deo_sPrenom; ?>
									</td>
									<td>
										<?php echo $this->md_config->affDateFrNum($l->deo_dDate); ?>
									</td>
									<td>
										<a href="<?php echo site_url("impression/depot_objet/".$l->deo_id); ?>"><i class="fa fa-print" style="font-size:20px"></i></a>
									</td>
								</tr>
							<?php } ?>
							</tbody>
