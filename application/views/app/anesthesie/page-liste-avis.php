								...
								<table id="example1" class="table table-bordered table-striped table-hover">
									...
									<?php foreach($listeAvisEncours AS $le){ ?>
										<tr>
											...
											<td>
												<?php if(is_null($le->pop_id)){echo $le->lac_sLibelle;}else{$res = $this->md_chirurgie->operation_planifiee($le->pop_id); echo $res->lac_sLibelle;}; ?>
											</td>
											<td><?php echo $this->md_config->affDateFrNum($le->avs_dDate); ?></td>
											<td class="text-center">
												<a href="javascript:;<?php echo site_url("anesthesie/consultation_avis/".$le->acm_id."/".$le->avs_id); ?>"><b><i class="fa fa-stethoscope" style="font-size:23px"></i><br>Consulter</b></a>
											</td>
										</tr>
									<?php } ?>
									</tbody>
