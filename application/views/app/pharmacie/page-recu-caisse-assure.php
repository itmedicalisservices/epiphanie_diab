...
<?php $liste = $this->md_pharmacie->liste_recu_caisse_assure(); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">liste des reçus de caisse pharmacie - par assurance</h2>
						...
						<table id="example" class="table table-bordered table-striped table-hover" style="font-size:12px">
							...
							<?php foreach($liste AS $l){ ?>
								<tr>
									...
									<td>
										<span><?php echo $l->fac_iMontantAss; ?> <small>FCFA</small></span>
									</td>
									<td>
