...
<?php $liste = $this->md_pharmacie->liste_produit_sorties(); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">liste des produits sorties en stock </h2>
						...
						<table id="example" class="table table-bordered table-striped table-hover">
							...
							<?php foreach($liste AS $l){ ?>
								<tr>
									...
									<td><?=$l->des_iQte;?></td>
									<td><?=$l->des_iQte*$l->des_iPrix;?></td>
									<td><?=$l->des_sMotif;?></td>
									<td><?=$this->md_config->affDateFrNum($l->des_dDateDestock);?></td>
								</tr>
							<?php } ?>
							</tbody>
						</table>
