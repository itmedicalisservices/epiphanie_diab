                ...
                <div class="card">
                    <div class="body"> 
                        ...
                        <div class="tab-content">
                            ...
                            <?php if(!empty($liste)){?>
							<a href="javascript:;<?php echo site_url("impression/dossier_medical_passage/".$acm_id); ?>" class="btn btn-raised bg-blue-grey" style="color:white; font-size:13px"><i class="fa fa-print"></i> Imprimer le dossier médical</a>
							<?php } ?>		
