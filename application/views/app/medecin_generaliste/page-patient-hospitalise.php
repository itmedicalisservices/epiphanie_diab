                ...
                <div class="card">
                    <div class="body"> 
                        ...
                        <div class="tab-content">
							...
							<div role="tabpanel" class="tab-pane" id="cptRendu">
                                <div class="header" style="margin-top:45px">
									<h2>Compte rendu de l'opération</h2>
								</div>
									...
									<form id="">
										<div class="row clearfix">
											<div class="col-sm-12">
												<div class="form-group">
													<div class="form-group">
														<b><?php if($cptRendu->pop_iResultat > 0){echo 'Résultat';} ;?></b>
													</div>
												</div>
											</div>
											<div class="col-sm-12">
												<div class="form-group">
													<div class="form-group">
														<b><?php echo $cptRendu->pop_sCompteRendu ;?></b>
													</div>
												</div>
											</div>
										</div>
				...
				<form id="motif-fin">
					<div class="form-group">
						...
						<select name="motif" class="form-control obligatoire" style="border:1px solid black">
							...
							<option value="evasion remission">Evasion rémission</option>
