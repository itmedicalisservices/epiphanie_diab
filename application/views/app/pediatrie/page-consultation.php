                ...
                <div class="card">
                    <div class="body"> 
                        ...
                        <ul class="nav nav-tabs" role="tablist" style="font-size:13.5px">
                            ...
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#postpartum"><b>Dossier post-partum</b></a></li>
                        </ul>
						<ul class="nav nav-tabs" role="tablist" style="font-size:13.5px">
							<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#compteRendu"><b>Compte rendu du suivi en post-partum immédiat</b></a></li>
						</ul>
                        ...
                        <div class="tab-content">
                                                ...
                                                <tr>
                                                    <td>
                                                        <select id="specialite" style="width:100%;padding-bottom:5px;padding-top:5px">
                                                            ...
                                                            <option value="4-/-Rumatologie"> Rumatologie </option>
							...
							<div role="tabpanel" class="tab-pane" id="postpartum">
                                <div class="header" style="margin-top:45px">
									<h2>Fiche de liaison : maternité <i class="fa fa-arrow-right"></i> suivi en post-partum immédiat <small>renseignez tous les champs marqués par des (*)</small> </h2>
								</div>
								
								<div class="body">
									
									<form id="form-fiche">
										<p><u><strong>Précisions utiles</strong></u> (AMP, DPN, accompagnement psychologique ou social)</p>
											<div class="row clearfix">
												<div class="col-sm-12">
													<div class="form-group">
														<div class="form-line">
											...
											<p><u><strong>Demande initié:</strong></u></p>
											<div class="row clearfix">
												<div class="col-sm-4">
												  <input type="radio" id="femme" name="demande" value="Par la femme">
												  <label for="femme">Par la femme</label>
												</div>
												<div class="col-sm-4">
												  <input type="radio" id="ets" name="demande" value="Par l'établissement de santé">
												  <label for="ets">Par l'établissement de santé</label>
												</div>
												<div class="col-sm-4">
												  <input type="radio" id="prado" name="demande" value="Dans le cadre du PRADO">
												  <label for="prado">Dans le cadre du PRADO</label>
												</div>
												<div class="col-sm-4">
												  <input type="radio" id="autre" name="demande" value="Autre">
												  <label for="autre">Autre</label>
												</div>
											</div>
											
											<p><u><strong>Maternité:</strong></u></p>
											<p>Personne(s) à contacter en cas de nécessité</p>
											<div class="row clearfix">
												<div class="col-sm-6">
													<div class="form-group">
														<div class="form-line">
															<label style="color:#000">Pour la mère</label>
															<input type="text"class="form-control obligatoire" name="contactMere"></input>
														</div>
													</div>
												</div>
												<div class="col-sm-6">
													<div class="form-group">
														<div class="form-line">
															<label style="color:#000">Pour la nouveau-né</label>
															<input type="text"class="form-control obligatoire" name="contactEnfant"></input>
														</div>
													</div>
												</div>
											</div>
											
											<p><u><strong>Couverture sociale du patient:</strong></u></p>
											<div class="row clearfix">
												<div class="col-sm-4">
												  <input type="checkbox" id="mutuelle" name="mutuelle">
												  <label for="mutuelle">SS+Mutuelle</label>
												</div>
												<div class="col-sm-4">
												  <input type="checkbox" id="securiteSociale" name="securiteSociale">
												  <label for="securiteSociale">Sécurité sociale</label>
												</div>
												<div class="col-sm-4">
												...
												<div class="col-sm-4">
												  <input type="checkbox" id="absenceCouverture" name="absenceCouverture">
												  <label for="absenceCouverture">Absence de couverture</label>
												</div>
											</div>
											
											<p><u><strong>Suivi antenatal du patient:</strong></u></p>
											<div class="row clearfix">
												<div class="col-sm-4">
												  <input type="radio" id="sageFemme" name="suivi" value="Sage-femme">
												  <label for="sageFemme">Sage-femme</label>
												</div>
												<div class="col-sm-4">
												  <input type="radio" id="generaliste" name="suivi" value="Généraliste">
												  <label for="generaliste">Généraliste</label>
												</div>
												<div class="col-sm-4">
												  <input type="radio" id="gynecologue" name="suivi" value="Gynécologue">
												  <label for="gynecologue">Gynécologue</label>
												</div>
											</div>
											<div class="row clearfix">
												<div class="col-sm-4">
													<div class="form-group">
														<div class="form-line">
															<label style="color:#000">Nom(s)</label>
															<input type="text"class="form-control obligatoire" name="nomSuivi"></input>
														</div>
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
														<div class="form-line">
															<label style="color:#000">Prénom(s)</label>
															<input type="text"class="form-control obligatoire" name="prenomSuivi"></input>
														</div>
													</div>
												</div>
												<div class="col-sm-4">
											...
											<p><u><strong>Antécedants:</strong></u></p>
												<div class="row clearfix">
													<div class="col-sm-4">
													  <div class="form-group">
															<div class="form-line">
																<label style="color:#000">Gestité</label>
																<input type="number" class="form-control obligatoire" name="gestite"/>
															</div>
													   </div>
													</div>
													<div class="col-sm-4">
													...
													<div class="col-sm-4">
													  <div class="form-group">
															<div class="form-line">
																<label style="color:#000">RAI</label>
																<input type="text" class="form-control obligatoire" name="rai"/>
															</div>
													   </div>
													</div>
												</div>
												<p>Toxoplasme(date et résultat de la dernière sérologie) :</p>
												<div class="row clearfix">
													<div class="col-sm-6">
													  <div class="form-group">
															<div class="form-line">
																<label style="color:#000">Date</label>
																<input type="text"class="datepicker form-control obligatoire" name="dateSerologie"/>
															</div>
													   </div>
													</div>
													<div class="col-sm-6">
													  <div class="form-group">
															<div class="form-line">
																<label style="color:#000">Résultat</label>
																<input type="text"class="form-control obligatoire" name="resultatSerologie"/>
															</div>
													   </div>
													</div>
												</div>
												<div class="row clearfix">
													<div class="col-sm-12">
													  <div class="form-group">
															<div class="form-line">
																<label style="color:#000">Autres sérologie à signaler</label>
																<input type="text"class="form-control obligatoire" name="rai"/>
															</div>
													   </div>
													</div>
													<div class="col-sm-12">
													  <div class="form-group">
															<div class="form-line">
																<label style="color:#000">Antécédants médicaux ou obstétricaux particuliers</label>
																<input type="text"class="form-control obligatoire" name="anteObs"/>
															</div>
													   </div>
													</div>
												</div>
												<p><u><strong>Grossesse</strong></u></p>
													<div class="row clearfix">
														<div class="col-sm-4">
														  <input type="radio" id="sageFemme" name="grossesse" value="Grossesse normale">
														  <label for="sageFemme">Grossesse normale</label>
														</div>
														<div class="col-sm-4">
														  <input type="radio" id="generaliste" name="grossesse" value="Pathologie maternelle">
														  <label for="generaliste">Pathologie maternelle</label>
														</div>
														<div class="col-sm-4">
														  <input type="radio" id="gynecologue" name="grossesse" value="Pathologie foetale">
														  <label for="gynecologue">Pathologie foetale</label>
														</div>
													</div>
													<p><u><strong>Accouchement</strong></u></p>
													<div class="row clearfix">
													<div class="col-sm-4">
													  <div class="form-group">
															<div class="form-line">
																<input type="text"class="datepicker form-control obligatoire" name="dateSerologie" placeholder="Date"/>
															</div>
													   </div>
													</div>
													<div class="col-sm-2">
													  <div class="form-group">
															<div class="form-line">
																<input type="text"class="timepicker form-control obligatoire" name="dateSerologie" placeholder="Heure"/>
															</div>
													   </div>
													</div>
													<div class="col-sm-6">
													  <div class="form-group">
															<div class="form-line">
																<input type="text"class="form-control obligatoire" name="resultatSerologie" placeholder="Terme"/>
															</div>
													   </div>
													</div>
												</div>
												<p>Complications (préciser le cas échéant):</p>
												<div class="row clearfix">
													<div class="col-sm-4">
													  <input type="radio" id="delivrance" name="complication" value="De la délivrance">
													  <label for="delivrance">De la délivrance</label>
													</div>
													<div class="col-sm-4">
													  <input type="radio" id="anesthesiste" name="complication" value="D'anesthésiste">
													  <label for="anesthesiste">D'anesthésiste</label>
													</div>
													<div class="col-sm-4">
													  <input type="radio" id="autreComp" name="complication" value="Autre">
													  <label for="autreComp">Autre</label>
													</div>
												</div>
												
												<p><u>Points à surveiller:</u></p>
												<div class="row clearfix">
													<div class="col-sm-4">
													  <input type="checkbox" id="dechirure" name="dechirure">
													  <label for="dechirure">Déchirure simple/compliquée</label>
													</div>
													<div class="col-sm-4">
													  <input type="checkbox" id="perine" name="perine">
													  <label for="perine">Périné complet</label>
													</div>
													<div class="col-sm-4">
													  <input type="checkbox" id="evolution" name="evolution">
													  <label for="evolution">Evolution des fils résorbables</label>
													</div>
													<div class="col-sm-4">
													  <input type="checkbox" id="hematome" name="hematome">
													  <label for="hematome">Hématome</label>
													</div>
													<div class="col-sm-4">
													  <input type="checkbox" id="episiotomie" name="episiotomie">
													  <label for="episiotomie">Episiotomie</label>
													</div>
													<div class="col-sm-4">
													  <input type="checkbox" id="cicatrice" name="cicatrice">
													  <label for="cicatrice">Cicatrice de césarienne avec complication</label>
													</div>
													<div class="col-sm-4">
													  <input type="checkbox" id="filsAgraphe" name="filsAgraphe">
													  <label for="filsAgraphe">Fils/agraphes à retirer à j</label>
													</div>
													<div class="col-sm-4">
													  <input type="checkbox" id="hemo" name="hemo">
													  <label for="hemo">Hémorroides invalidantes</label>
													</div>
												</div>
												
												<p><u><strong>Période postnatale en maternité</strong></u></p>
												<div class="row clearfix">
													<div class="col-sm-4">
													  <input type="checkbox" id="physiologique" name="physiologique">
													  <label for="physiologique">Physiologique</label>
													</div>
													<div class="col-sm-4">
													  <input type="checkbox" id="pathologie" name="pathologie">
													  <label for="pathologie">Pathologique</label>
													</div>
												</div><br><br>
												<p>Date et dernier taux d'hémoglibine connu :</p>
												<div class="row clearfix">
													<div class="col-sm-6">
													  <div class="form-group">
															<div class="form-line">
													...
													<div class="col-sm-6">
													  <div class="form-group">
															<div class="form-line">
																<input type="text"class="datepicker form-control obligatoire" name="dateSerologie" placeholder="taux"/>
															</div>
													   </div>
													</div>
												</div>
												...
												<div class="row clearfix">
													<div class="col-sm-6">
														<div class="form-group">
															<div class="form-line">
															<label style="color:#000">Prescription de contraception</label>
																<select name="unite" class="form-control obligatoire">
																	<option value="">--------- Selectionner ----------</option>
																	<option value="inutile">inutile</option>
																	<option value="Non souhaitée">Non souhaitée</option>
													...
													<div class="col-sm-6">
														<div class="form-group">
															<div class="form-line">
															<label style="color:#000">Vaccination anti-coqueluche</label>
																<select name="unite" class="form-control obligatoire">
																	<option value="">--------- Selectionner ----------</option>
																	<option value="inutile">inutile</option>
																	<option value="Non souhaitée">Non souhaitée</option>
													...
													<div class="col-sm-6">
														<div class="form-group">
															<div class="form-line">
															<label style="color:#000">Vaccination anti-rubéole</label>
																<select name="unite" class="form-control obligatoire">
																	<option value="">--------- Selectionner ----------</option>
																	<option value="inutile">inutile</option>
																	<option value="Non souhaitée">Non souhaitée</option>
													...
													<div class="col-sm-6">
														<div class="form-group">
															<div class="form-line">
															<label style="color:#000">Immunoglobulines anti-D</label>
																<select name="unite" class="form-control obligatoire">
																	<option value="">--------- Selectionner ----------</option>
																	<option value="inutile">inutile</option>
																	<option value="Non souhaitée">Non souhaitée</option>
													...
													<p><u><strong>NOUVEAU-NE</strong></u></p>
													<div class="row clearfix">
														<div class="col-sm-6">
															<div class="form-group">
																<div class="form-line">
																	<input type="text" name="nomEnfant" class="form-control obligatoire" placeholder="Nom"/>
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																<div class="form-line">
																	<input type="text" name="prenomEnfant" class="form-control obligatoire" placeholder="Prénom"/>
																</div>
															</div>
														</div>
														<div class="col-sm-4">
														...
														<div class="col-sm-4">
															<div class="form-group">
																<div class="form-line">
																	<input type="number" name="poids" class="form-control obligatoire" placeholder="Poids de naissance"/>
																</div>
															</div>
														</div>
														<div class="col-sm-4">
															<div class="form-group">
																<div class="form-line">
																	<input type="number" name="poids" class="form-control obligatoire" placeholder="Poids le plus bas"/>
																</div>
															</div>
														</div>
														<div class="col-sm-4">
															<div class="form-group">
																<div class="form-line">
																	<label style="color:#000">Date de naissance</label>
																	<input type="text" name="poids" class="datepicker form-control obligatoire"/>
																</div>
															</div>
														</div>
														<div class="col-sm-4">
															<div class="form-group">
																<div class="form-line">
																	<label style="color:#000">Allaitement</label>
																	<select name="unite" class="form-control obligatoire">
																		<option value="">------ Selectiomner -----</option>
																		<option value="Sein">Sein</option>
																		<option value="Mixte">Mixte</option>
																		<option value="Prépaaration pour nourrisson">Prépaaration pour nourrisson</option>
																	</select>
																</div>
															</div>
														</div>
														<div class="col-sm-4">
															<div class="form-group">
																<div class="form-line">
																	<label style="color:#000">Guthrie</label>
																	<select name="unite" class="form-control obligatoire">
																		<option value="">------ Selectiomner -----</option>
																		<option value="Fait">Fait</option>
														...
														<div class="col-sm-4">
															<div class="form-group">
																<div class="form-line">
																	<label style="color:#000">Dépistage de la surdité</label>
																	<select name="unite" class="form-control obligatoire">
																		<option value="">------ Selectiomner -----</option>
																		<option value="Fait">Fait</option>
																		<option value="à proposer">à proposer</option>
																	</select>
																</div>
															</div>
														</div>
													...
													<div class="row clearfix">
														...
														<div class="col-sm-4">
														  <input type="checkbox" id="ictere" name="ictere">
														  <label for="ictere">Ictère</label>
														</div>
														<div class="col-sm-4">
														...
														<div class="col-sm-4">
														  <input type="checkbox" id="poids" name="poids">
														  <label for="poids">Prise de poids</label>
														</div>
														<div class="col-sm-4">
														  <input type="checkbox" id="autrep" name="autrep">
														  <label for="autrep">Autre</label>
														</div>
													</div>
													<div class="row clearfix">
														<div class="col-sm-12">
															<div class="form-group">
																<div class="form-line">
																	<input type="text" name="poids" class="datepicker form-control obligatoire" placeholder="Date de sortie"/>
																</div>
															</div>
														</div>
														<p>Accompagnement(s) proposé(s):</p>
														<div class="col-sm-4">
														  <input type="checkbox" id="Sage_femme" name="Sage_femme">
														  <label for="Sage_femme">Sage-femme libérale</label>
														</div>
														<div class="col-sm-4">
														  <input type="checkbox" id="puericultrice" name="puericultrice">
														  <label for="puericultrice">Puéricultrice(PMI)</label>
														</div>
														<div class="col-sm-4">
														  <input type="checkbox" id="tisf" name="tisf">
														  <label for="tisf">TISF</label>
														</div>
														<div class="col-sm-4">
														  <input type="checkbox" id="phychologue" name="phychologue">
														  <label for="phychologue">Phychologue</label>
														</div>
														<div class="col-sm-4">
														  <input type="checkbox" id="medGeneraliste" name="medGeneraliste">
														  <label for="medGeneraliste">Médecin généraliste</label>
														</div>
														<div class="col-sm-4">
														  <input type="checkbox" id="pediatre" name="pediatre">
														  <label for="pediatre">Pédiatre</label>
														</div>
														<div class="col-sm-4">
														  <input type="checkbox" id="allaitement" name="allaitement">
														  <label for="allaitement">Soutien à l'allaitement</label>
														</div>
														<div class="col-sm-4">
														  <input type="checkbox" id="autreAc" name="autreAc">
														  <label for="autreAc">Autre</label>
														</div>
													</div>		
												</div>		
													<div style="color:red" class="col-sm-12 retour-fiche"></div>
										
										<div class="row clearfix">
											
											<div class="col-sm-12">
												<a class="btn btn-raised bg-blue-grey" id="AddFiche">Enregistrer</a>
											</div>
										</div>
									</form>
								</div>
							...
							<div role="tabpanel" class="tab-pane" id="compteRendu">
								<div class="header" style="margin-top:45px">
									<h2>Compte rendu du suivi en post-partum<small>A l'attention du service maternité</small></h2>
								</div>
									...
									<div class="col-sm-12 retour-new-deces"></div>
											...
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														...
														<input type="text" name="nomMere" class="form-control obligatoire">
													</div>
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														...
														<input type="text" name="prenomMere" class="form-control obligatoire">
													</div>
												</div>
											</div>											
											<div class="col-sm-6">
												<div class="form-group">
													<div class="form-line">
													<label style="color:#000">Date de naissance</label>
														<input type="text" name="dateNaiss" class="datepicker form-control obligatoire">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row clearfix">
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														<label style="color:#000">Nom</label>
														<input type="text" name="nomNouv" class="form-control obligatoire">
													</div>
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														<label style="color:#000">Prénom</label>
														<input type="text" name="prenomNouv" class="form-control obligatoire">
													</div>
												</div>
											</div>											
											<div class="col-sm-6">
												<div class="form-group">
													<div class="form-line">
													<label style="color:#000">Date de naissance</label>
														<input type="text" name="dateNaissNouv" class="datepicker form-control obligatoire">
													</div>
												</div>
											</div>											
										...
										<div class="row clearfix">
											<div class="col-sm-6">
												<div class="form-group">
													<div class="form-line">
														<label style="color:#000">Du</label>
														<input type="text" name="dateDebut" class="datepicker form-control obligatoire">
													</div>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
													<div class="form-line">
														<label style="color:#000">Au</label>
														<input type="text" name="dateFin" class="datepicker form-control obligatoire">
													</div>
												</div>
											</div>
										</div>
											
										<h3><u>Evaluation médicale</u></h3>
										<div class="row clearfix">
											<div class="col-sm-12">
												<div class="form-group">
													<div class="form-line">
														<label style="color:#000">Date</label>
														<input type="text" name="dateEva" class="datepicker form-control obligatoire">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row clearfix">
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
														...
														<select name="unite" class="form-control obligatoire">
															<option value="">------ Selectiomner -----</option>
															<option value="Fait">Normal</option>
															<option value="à proposer">à surveiller</option>
														</select>
													</div>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
														...
														<select name="unite" class="form-control obligatoire">
															<option value="">------ Selectiomner -----</option>
															<option value="Fait">lait maternel</option>
															<option value="à proposer">Mixte</option>
															<option value="à proposer">Préparation pour nourrisson</option>
														</select>
													</div>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
														...
														<select name="unite" class="form-control obligatoire">
															<option value="">------ Selectiomner -----</option>
															<option value="Fait">Favorable</option>
															<option value="à proposer">à soutenir</option>
														</select>
													</div>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
														<label style="color:#000">Fils/ agrafes retirés le</label>
														<input type="text" name="dateFin" class="datepicker form-control obligatoire">
													</div>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
														<label style="color:#000">Prescriptions</label>
														<select name="unite" class="form-control obligatoire">
															<option value="">------ Selectiomner -----</option>
										...
										<h3><u>Evaluation psycho-sociale</u></h3>
										<div class="row clearfix">
											<div class="col-sm-12">
												<div class="form-group">
													<div class="form-line">
														<label style="color:#000">Evolution psychologique(baby-blues, relations mère-enfant,...)</label>
														<textarea class='edit' name="evolution" style="margin-top: 30px;" placeholder="Saisissez ici"></textarea>
													</div>
												</div>
											</div>
											<div class="col-sm-12">
												<div class="form-group">
													<div class="form-line">
														<label style="color:#000">Difficultés particulières</label>
														<textarea class='edit' name="difficultes" style="margin-top: 30px;" placeholder="Saisissez ici"></textarea>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row clearfix">
											<div class="col-sm-12">
												<div class="form-group">
													<div class="form-line">
														<input type="text" name="dateFin" class="datepicker form-control obligatoire" placeholder="Noms et fonctions des professionnelles"/>
													</div>
												</div>
											</div>
											<div class="col-sm-12">
												<div class="form-group">
													<div class="form-line">
														<input type="text" name="dateFin" class="datepicker form-control obligatoire" placeholder="Motifs"/>
													</div>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
														<input type="text" name="dateFin" class="datepicker form-control obligatoire" placeholder="Date du prochain rendez-vous">
													</div>
												</div>
											</div>
										</div>
