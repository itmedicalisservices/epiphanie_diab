...
$listeApres = $this->md_patient->liste_acm_encours(date("Y-m-d H:i:s"),$this->session->diabcare);
 $liste = $this->md_chirurgie->tableau_patients_operes();
 ?>
            ...
            <div role="tabpanel" class="tab-pane active in" id="income">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="card">
							<div class="header">
								<h2>Suivi des patients après opération</h2>
							</div>
									...
									<?php foreach($liste AS $le){ ?>
										<tr>
											...
											<td class="text-center">
												<a href="<?php echo site_url("chirurgie/saisir/".$le->acm_id); ?>"><b><i class="fa fa-file-text" style="font-size:23px"></i><br>Consulter</b></a>
											</td>
										</tr>
									<?php } ?>
									</tbody>
