                ...
                <div class="card">
                    <div class="body"> 
                        ...
                        <ul class="nav nav-tabs" role="tablist" style="font-size:14px">
							...
							<li class="nav-item"><a class="nav-link" data-toggle="tab" id="cc" href="#saisie"><b>Consultation anesthésique</b></a></li>
						 ...
						 <ul class="nav nav-tabs" role="tablist" style="font-size:14px">
                            ...
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#imagerie" id="in"><b>Examen imagérie</b></a></li>
						...
						<?php if(isset($avs)){?>
						<?php $recupPop = $this->md_chirurgie->recup_acte_chirurgical($avs);?>
							<div class="body table-responsive">
								<table id="" class="table table-bordered table-striped table-hover">
									...
									<tbody>
											...
											<td><?php $res = $this->md_chirurgie->operation_planifiee($recupPop->pop_id); echo $res->lac_sLibelle;?></td>
                        ...
                        <div class="tab-content">
											...
											<div class="form-group">
												<div class="form-line">
													...
													<?php if($information){?>
														...
														<option value="O +" <?php if($information->inc_sSang=="O +"){echo 'selected="selected"';}else{echo '';} ;?>>O +</option>
														<option value="A +" <?php if($information->inc_sSang=="A +"){echo 'selected="selected"';}else{echo '';} ;?>>A +</option>
														<option value="B +" <?php if($information->inc_sSang=="B +"){echo 'selected="selected"';}else{echo '';} ;?>>B +</option>
														<option value="O -" <?php if($information->inc_sSang=="O -"){echo 'selected="selected"';}else{echo '';} ;?>>O -</option>
														<option value="A -" <?php if($information->inc_sSang=="A -"){echo 'selected="selected"';}else{echo '';} ;?>>A -</option>
														<option value="AB +" <?php if($information->inc_sSang=="AB +"){echo 'selected="selected"';}else{echo '';} ;?>>AB +</option>
														<option value="B -" <?php if($information->inc_sSang=="B -"){echo 'selected="selected"';}else{echo '';} ;?>>B -</option>
														<option value="AB -" <?php if($information->inc_sSang=="AB -"){echo 'selected="selected"';}else{echo '';} ;?>>AB -</option>
													<?php }else{?>
														<option value="">Choisir</option>
											...
											<div class="form-group">
												<div class="form-line">
													...
													<table class="table table-bordered table-striped table-hover">
														<thead>
															<tr>
																<th style="width:95%">Liste des antécédents personnels</th>
											...
											<div class="form-group">
												<div class="form-line">
													...
													<table class="table table-bordered table-striped table-hover">
														<thead>
															<tr>
																<th style="width:95%">Liste des antécédents familiaux</th>
																<th style="width:20px"  class="text-center"><i class="fa fa-wrench"></i></th>
															</tr>
															<tr>
																<td>
                                        ...
                                        <form id="form-avis">
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="width:40%">Motif de la demande d'avis médical</th>
                                                    <th style="width:20px"  class="text-center"><i class="fa fa-wrench"></i></th>
                                                </tr>
                                                <tr>
                                                    <td>
								...
								<div class="body">
									<form id="form-avis">
										<div class="row">
											...
											<div class="col-sm-12">
												<div class="body table-responsive">
													<div class="col-sm-12">
														<div class="form-group">
															<div class="form-line">
																<label style="color:#000">Votre avis * </label>
																<textarea id='edit_3' name="avis" class="form-control obligatoire" style="margin-top: 30px;" placeholder="Saisissez votre avis ici"></textarea>
															</div>
														</div>
													</div>
											...
											<div class="col-sm-12 pull-left retour"></div>
											<button type="submit" class="btn btn-success waves-effect pull-right" id="addAvis" style="color:#fff"><i class="fa fa-check"></i> Enregistrer</button>
										</div>
									</form>
								</div>
                            </div>
							...
							<div role="tabpanel" class="tab-pane" id="imagerie">
                                <div class="header" style="margin-top:45px">
									<h2>Prescription imagérie <small>Ajoutez les éléments dans la liste et puis validez</small> </h2>
								</div>
...
<script type="text/javascript">
        ...
        addAct.addEventListener('click', addDetailEqui);
        ...
        function showListePer() 
        {
            ...
            for(var i = 0; i < tailleTableau; i++) {
				...
				var tabAct = annuaire[i].acte.split("-/-");
