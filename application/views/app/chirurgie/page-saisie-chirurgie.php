                ...
                <div class="card">
                    <div class="body"> 
                        ...
                        <ul class="nav nav-tabs" role="tablist" style="font-size:14px">
							...
							<li class="nav-item"><a class="nav-link" data-toggle="tab" id="cc" href="#saisie"><b>Compte rendu de l'opération</b></a></li>
                        ...
                        <div class="tab-content">
													...
													<td colspan="2">
														<table style="width:100%;padding:0">
															...
															<tr>
																<td>Antécédents</td>
																<td style="width:17.6%">
																	<a href="javascript:();" rel="<?php echo $acm->pat_id;  ?>" class="text-info info_sej" style="color:#fff"><i class="fa fa-arrow-right pull-right" style="font-size:25px"></i></a>
																</td>
															</tr>
															<?php } ?>
                                ...
                                <form id="form-complement">
									...
									<div class="row clearfix">
										<div class="col-sm-12">
											<div class="form-group">
												<div class="form-line">
													<label style="color:#000">Antécédents personnels et familiaux</label>
													<textarea class='edit' name="antecedent" style="margin-top: 30px;" placeholder="Saissez les ici"><?php if($information){echo $information->inc_sAnt ;}?></textarea>
												</div>
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group">
												<div class="form-line">
													...
													<textarea class='edit' name="allergie" style="margin-top: 30px;" placeholder="Saissez les ici"><?php if($information){echo $information->inc_sAll ;}?></textarea>
												</div>
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group">
												<div class="form-line">
													...
													<textarea class='edit' name="prof" style="margin-top: 30px;" placeholder="Saissez les ici"><?php if($information){echo $information->inc_sActPro ;}?></textarea>
												</div>
											</div>
										</div>
										<div class="col-sm-12">
							...
							<div role="tabpanel" class="tab-pane" id="saisie">
                                  <div class="header" style="margin-top:45px">
									<h2>Faire un reporting de l'opération <small>renseignez tous les champs marqués par des (*)</small> </h2>
											...
											<div class="col-sm-12">
												<div class="body table-responsive">
													<table class="table table-bordered table-striped table-hover">
														<thead>
															<tr>
																<th style="width:99%">Actes chirurgicaux effectués *</th>
																<th style="width:60px"  class="text-center"><i class="fa fa-wrench"></i></th>
															</tr>
															<tr>
																<td>
																	
																	<select name="acte" id="acte" class="obligatoire"  style="width:100%;padding-bottom:5px;padding-top:5px">
																...
																<td class="text-center">
																	<a href="javascript:();" class="btn btn-sm waves-effect bg-blue-grey" id="compteRendu"><i class="fa fa-plus"></i></a>
																</td>
															</tr>
														</thead>
													...
													<div class="col-sm-12">
														<div class="form-group">
															<div class="form-line">
																<label style="color:#000">Compte rendu de l'opération *</label>
																<textarea id='edit_3' name="contenu" style="margin-top: 30px;" placeholder="Saissez les ici"></textarea>
															</div>
														</div>
													</div>
													<input type="hidden" value="<?php echo $acm->pat_id; ?>" name="id">
												</div>
											</div>
											<div class="col-sm-12 pull-left retour"></div>
											<button type="submit" class="btn btn-success waves-effect pull-right" id="addSaisie" style="color:#fff"><i class="fa fa-check"></i> Enregistrer</button>
										</div>
									</form>
								</div>
                            </div>
...
<div class="modal fade" id="modalConsulte" tabindex="-1" role="dialog">
 ...
 <script type="text/javascript">
        ...
        var compteRendu = document.querySelector('#compteRendu');
        var annuaire;
        annuaire = new Array();
        ...
        compteRendu.addEventListener('click', addDetailSer);
        ...
        function showListeSer() 
        {
            ...
            for(var i = 0; i < tailleTableau; i++) {
                ...
                contenu += '<tr>';
                contenu += '<td><input type="hidden" name="acte[]" value="'+ annuaire[i].acte+'"/>' + annuaire[i].acte + '</td>';
