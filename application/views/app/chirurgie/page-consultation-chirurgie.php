                ...
                <div class="card">
                    <div class="body"> 
                        ...
                        <ul class="nav nav-tabs" role="tablist" style="font-size:13.5px">
                            ...
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#planing"><b>Planification</b></a></li>
                        ...
                        <div class="tab-content">
										...
										<table class="table table-bordered table-striped table-hover">
											...
											<thead>
												...
												<?php 
													...
													$planing_sejour = $this->md_patient->panning_operation_sejour($l->sea_id);
												...
												<tr>
													...
													<td colspan="2">
														<table style="width:100%;padding:0">
															...
															<?php if($planing_sejour){ ?>
															<tr>
																<td>Planification d'opération</td>
																<td style="width:17.6%">
																	<a href="javascript:();" rel="<?php echo $l->sea_id;  ?>" class="text-info plan_sej" style="color:#fff"><i class="fa fa-arrow-right pull-right" style="font-size:25px"></i></a>
																</td>
															</tr>
															<?php } ?>
							...
							<div role="tabpanel" class="tab-pane" id="planing">
                                  <div class="header" style="margin-top:45px">
									<h2>Faire une planification des opérations <small>renseignez tous les champs marqués par des (*)</small> </h2>
								...
								<div class="body">
									...
									<form id="form-ope">
										<div class="row">
											...
											<div class="col-sm-4">
												<div class="header">
													<h2>Planification de l'opération</h2>	
												</div>
												<div class="form-group">
													<div class="form-line">
														<select name="acte" class="obligatoire"  style="width:100%;padding-bottom:5px;padding-top:5px">
														<option value="">----- Acte chirurgical * -----</option>
														<?php $acte = $this->md_parametre->liste_prescription(22); foreach($acte AS $a){if($a->lac_id != 65){ ?>
														<option value="<?php echo $a->lac_id; ?>"><?php echo $a->lac_sLibelle; ?></option>
														<?php } } ?>
														</select>
													</div>
												</div>
												<div class="form-group">
													<div class="form-line">
														<select name="bloc" id="bloc" class="obligatoire" style="width:100%;padding-bottom:5px;padding-top:5px">
														<option value="">-- Choisissez le bloc opératoire * --</option>
														<?php $bloc = $this->md_parametre->liste_bloc_actifs(); foreach($bloc AS $b){ ?>
														<option value="<?php echo $b->bop_id; ?>"><?php echo $b->bop_sLibelle; ?></option>
														<?php } ?>
														</select>
													</div>
												</div>
												<div class="form-group">
													<div class="form-line">
														<select name="salle" id="salleOp" class="obligatoire" style="width:100%;padding-bottom:5px;padding-top:5px">
												...
												<div class="form-group">
													<div class="form-line">
														<input type="text" name="date" class="datepicker form-control obligatoire" placeholder="Date d'opération *">
													</div>
												</div>
												<div class="form-group">
													<div class="form-line">
														<input type="text" name="heureDebut" class="timepicker form-control obligatoire" placeholder="Heure de debut *">
													</div>
												</div>
												<div class="form-group">
													<div class="form-line">
														<input type="text" name="heureFin" class="timepicker form-control obligatoire" placeholder="Heure de fin *">
														<input type="hidden" value="<?php echo $acm_id; ?>" name="id_chi">
														<input type="hidden" value="<?php echo $acm->pat_id; ?>" name="pat_chi">
													</div>
												</div>
												...
												<div class="body table-responsive">
													<table class="table table-bordered table-striped table-hover">
														<thead>
															...
															<tr>
																<td>
																	<select id="agent" name="personnel" style="width:100%;padding-bottom:5px;padding-top:5px">
																		<option value="">----- Choisissez l'agent * -----</option>
																		<?php $listePer = $this->md_personnel->nb_complete_personnel(); foreach($listePer AS $l){ ?>
																...
																<td>
																	<select id="role" name="role" style="width:100%;padding-bottom:5px;padding-top:5px">
											...
											<div class="col-sm-12">
												<div class="form-group">
													<div class="form-line">
														...
														<textarea id='edit_3' name="description" style="margin-top: 30px;"></textarea>
													</div>
												</div>
											</div>
											<div class="col-sm-12 pull-left retour"></div>
											<button type="submit" class="btn btn-success waves-effect pull-right" id="addOpe" style="color:#fff"><i class="fa fa-check"></i> Enregistrer</button>
										</div>
