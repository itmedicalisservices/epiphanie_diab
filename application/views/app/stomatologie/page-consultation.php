												...
												<div class="panel-body"> 
													...
													<div class="col-sm-12" style="padding:0;">
															<table class="" style="font-size:12px;width:100%">
																<thead>
																	<tr>
																		<th class="text-center" colspan="4">SUP</th>
																	</tr>																	
																	
																	<tr>
																		<th style="padding-bottom:2%" class="text-center" rowspan="2">D</th>
																		<th style="padding-left:2%;border-bottom:2px solid black;border-right:2px solid black">
																			<input type="checkbox" id="checkbox_1" name="dent[]" value="133-/-Troisième Molaire-/-Supérieure Droite">
																			<label for="checkbox_1"><b>8</b></label>
																			<input type="checkbox" id="checkbox_2" name="dent[]" value="133-/-Deuxième Molaire-/-Supérieure Droite">
																			<label for="checkbox_2"><b>7</b></label>
																			<input type="checkbox" id="checkbox_3" name="dent[]" value="133-/-Première Molaire-/-Supérieure Droite">
																			<label for="checkbox_3"><b>6</b></label>
																			<input type="checkbox" id="checkbox_4" name="dent[]" value="134-/-Deuxième Prémolaire-/-Supérieure Droite">
																			<label for="checkbox_4"><b>5</b></label>
																			<input type="checkbox" id="checkbox_5" name="dent[]" value="134-/-Première Prémolaire-/-Supérieure Droite">
																			<label for="checkbox_5"><b>4</b></label>
																			<input type="checkbox" id="checkbox_6" name="dent[]" value="131-/-Canine-/-Supérieure Droite">
																			<label for="checkbox_6"><b>3</b></label>
																			<input type="checkbox" id="checkbox_7" name="dent[]" value="132-/-Insicive Latérale-/-Supérieure Droite">
																			<label for="checkbox_7"><b>2</b></label>
																			<input type="checkbox" id="checkbox_8" name="dent[]" value="132-/-Insicive Centrale-/-Supérieure Droite">
																			<label for="checkbox_8"><b>1</b></label>
																		</th>
																		<th style="padding-left:3%;border-bottom:2px solid black">
																			<label for="checkbox_9"><b>1</b></label>
																			<input type="checkbox" id="checkbox_9" name="dent[]" value="132-/-Insicive Centrale-/-Supérieure Gauche">
																			
																			<label for="checkbox_10"><b>2</b></label>
																			<input type="checkbox" id="checkbox_10" name="dent[]" value="132-/-Insicive Latérale-/-Supérieure Gauche">
																			
																			<label for="checkbox_11"><b>3</b></label>
																			<input type="checkbox" id="checkbox_11" name="dent[]" value="131-/-Canine-/-Supérieure Gauche">
																			
																			<label for="checkbox_12"><b>4</b></label>
																			<input type="checkbox" id="checkbox_12" name="dent[]" value="134-/-Première Prémolaire-/-Supérieure Gauche">
																			
																			<label for="checkbox_13"><b>5</b></label>
																			<input type="checkbox" id="checkbox_13" name="dent[]" value="134-/-Deuxième Prémolaire-/-Supérieure Gauche">
																			
																			<label for="checkbox_14"><b>6</b></label>
																			<input type="checkbox" id="checkbox_14" name="dent[]" value="133-/-Première Molaire-/-Supérieure Gauche">
																			
																			<label for="checkbox_15"><b>7</b></label>
																			<input type="checkbox" id="checkbox_15" name="dent[]" value="133-/-Deuxième Molaire-/-Supérieure Gauche">
																			
																			<label for="checkbox_16"><b>8</b></label>
																			<input type="checkbox" id="checkbox_16" name="dent[]" value="133-/-Troisième Molaire-/-Supérieure Gauche">
																			<label for="" style="color:#fff">1</label>
																		</th>
																		<th style="padding-bottom:2%"  class="text-center" rowspan="2" style="">G</th>
																	</tr>																	
																	
																	<tr>
																		<th style="padding-left:2%;padding-top:2%;border-right:2px solid black">
																			<input type="checkbox" id="checkbox_17" name="dent[]" value="133-/-Troisième Molaire-/-Inférieure Droite">
																			<label for="checkbox_17"><b>8</b></label>
																			<input type="checkbox" id="checkbox_18" name="dent[]" value="133-/-Deuxième Molaire-/-Inférieure Droite">
																			<label for="checkbox_18"><b>7</b></label>
																			<input type="checkbox" id="checkbox_19" name="dent[]" value="133-/-Première Molaire-/-Inférieure Droite">
																			<label for="checkbox_19"><b>6</b></label>
																			<input type="checkbox" id="checkbox_20" name="dent[]" value="134-/-Deuxième Premolaire-/-Inférieure Droite">
																			<label for="checkbox_20"><b>5</b></label>
																			<input type="checkbox" id="checkbox_21" name="dent[]" value="134-/-Première Premolaire-/-Inférieure Droite">
																			<label for="checkbox_21"><b>4</b></label>
																			<input type="checkbox" id="checkbox_22" name="dent[]" value="131-/-Canine-/-Inférieure Droite">
																			<label for="checkbox_22"><b>3</b></label>
																			<input type="checkbox" id="checkbox_23" name="dent[]" value="132-/-Insicive Latérale-/-Inférieure Droite">
																			<label for="checkbox_23"><b>2</b></label>
																			<input type="checkbox" id="checkbox_24" name="dent[]" value="132-/-Insicive centrale-/-Inférieure Droite">
																			<label for="checkbox_24"><b>1</b></label>
																		</th>
																		<th style="padding-left:3%;padding-top:2%;">
																			<label for="checkbox_25"><b>1</b></label>
																			<input type="checkbox" id="checkbox_25" name="dent[]" value="132-/-Insicive Centrale-/-Inférieure Gauche">
																			
																			<label for="checkbox_26"><b>2</b></label>
																			<input type="checkbox" id="checkbox_26" name="dent[]" value="132-/-Insicive Latérale-/-Inférieure Gauche">
																			
																			<label for="checkbox_27"><b>3</b></label>
																			<input type="checkbox" id="checkbox_27" name="dent[]" value="131-/-Canine-/-Inférieure Gauche">
																			
																			<label for="checkbox_28"><b>4</b></label>
																			<input type="checkbox" id="checkbox_28" name="dent[]" value="134-/-Première Premolaire-/-Inférieure Gauche">
																			
																			<label for="checkbox_29"><b>5</b></label>
																			<input type="checkbox" id="checkbox_29" name="dent[]" value="134-/-Deuxième Premolaire-/-Inférieure Gauche">
																			
																			<label for="checkbox_30"><b>6</b></label>
																			<input type="checkbox" id="checkbox_30" name="dent[]" value="133-/-Première Molaire-/-Inférieure Gauche">
																			
																			<label for="checkbox_31"><b>7</b></label>
																			<input type="checkbox" id="checkbox_31" name="dent[]" value="133-/-Deuxième Molaire-/-Inférieure Gauche">
																			
																			<label for="checkbox_32"><b>8</b></label>
																			<input type="checkbox" id="checkbox_32" name="dent[]" value="133-/-Troisième Molaire-/-Inférieure Gauche">
																			<label for="" style="color:#fff">1</label>
																		</th>
																	</tr>																	
																	
																	<tr>
																		<th class="text-center" colspan="4">INF</th>
																	</tr>
																</thead>
															</table>
													</div>																												
