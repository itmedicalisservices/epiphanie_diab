											...
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														...
														<input type="text" value="<?php if(!is_null($constante)){echo $constante->con_iGlmie;}?>" name="glycemie" class="form-control glycemie">
													</div>
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														...
														<input type="text" value="<?php if(!is_null($constante)){echo $constante->con_iTemperature;}?>" name="temperature" class="form-control">
													</div>
												</div>
											</div>												
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														...
														<input type="text" value="<?php if(!is_null($constante)){echo $constante->con_fPoulsation;}?>" name="poul" class="form-control">
													</div>
												</div>
											</div>											
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														...
														<input type="text" value="<?php if(!is_null($constante)){echo $constante->con_fTourTaille;}?>" name="Ttaille" class="form-control">
													</div>
												</div>
											</div>		
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														...
														<?php if(is_null($constante->con_sCetonique)){?>
														...
														<option value="++++" >++++</option>
														<?php }else{?>
															<option value="Négatif" <?php if($constante->con_sCetonique == 'Négatif'){echo 'selected="selected"';} ;?>>Négatif</option>
															<option value="Plus ou moins"  <?php if($constante->con_sCetonique == 'Plus ou moins'){echo 'selected="selected"';} ;?>>Plus ou moins</option>
															<option value="+"  <?php if($constante->con_sCetonique == '+'){echo 'selected="selected"';} ;?>>+</option>
															<option value="++"  <?php if($constante->con_sCetonique == '++'){echo 'selected="selected"';} ;?>>++</option>
															<option value="+++"  <?php if($constante->con_sCetonique == '+++'){echo 'selected="selected"';} ;?>>+++</option>
															<option value="++++"  <?php if($constante->con_sCetonique == '++++'){echo 'selected="selected"';} ;?>>++++</option>
														<?php }?>
											...
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														...
														<input type="number" min="0" value="<?php if(!is_null($constante)){echo $constante->con_iPdbg;}?>" name="pdbg" class="form-control">
													</div>
												</div>
											</div>												
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														...
														<input type="number" min="0" value="<?php if(!is_null($constante)){echo $constante->con_iPdbd;}?>" name="pdbd" class="form-control">
													</div>
												</div>
											</div>												
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														...
														<input type="number" min="0" value="<?php if(!is_null($constante)){echo $constante->con_iPcbg;}?>" name="pcbg" class="form-control">
													</div>
												</div>
											</div>											
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														...
														<input type="number" min="0" value="<?php if(!is_null($constante)){echo $constante->con_iPcbd;}?>" name="pcbd" class="form-control">
													</div>
												</div>
											</div>																							
											<div class="col-sm-12">
												<div class="form-group">
													<div class="form-line">
														...
														<textarea style="height:100px" name="obs"  class="form-control "><?php if(!is_null($constante)){echo $constante->con_sObs;}?></textarea>
													</div>
												</div>
											</div>											
										</div>
											...
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
														...
														<select class="form-control obligatoire" name="dec">
											...
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
														...
														<input type="date" value="<?php if(!is_null($infodiabete)){echo $infodiabete->ind_dDec;}?>" name="date" id="" class=" form-control obligatoire" placeholder="Sélectionner la date">
														<input type="hidden" value="<?php echo $acm_id; ?>" name="id">
														<input type="hidden" value="<?php echo $acm->pat_id; ?>" name="pat">
													</div>
												</div>
											...
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
														...
														<select class="form-control obligatoire" name="type">
															<option value="" > -- sélectionner -- </option>
											...
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
														...
														<select class="form-control obligatoire" name="suivi">
											...
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
														...
														<select class="form-control obligatoire" name="rythme">
											...
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
														...
														<select class="form-control obligatoire" name="qualite">
