...
<?php $assigne = $this->md_patient->patient_cardiologie($id); ?>
<?php $prescripteur = $this->md_patient->medecin_prescripteur_imagerie($assigne->car_id); ?>

<section class="content profile-page">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Examen cardiologique</h2>
					 ...
					 <div class="body"> 
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12">
								...
								<p><?php echo $this->md_config->affDateTimeFr($assigne->car_dDate);?></p>
							...
							<div class="col-lg-12 col-md-12 col-sm-12">
								<form id="form-cardiologie">
									<br><br>
									<strong>Interpretation</strong><br><br>
									<textarea id='edit' name="interpretation" rows="2"></textarea><br><br>
								...
								<br>
								<a href="javascript:();" onclick="return confirm('Confirmez la validation des résultats des examens ?');" style="color:#fff" class="btn btn-success effectuerCardio">Examen effecté</a>
							</div>
						</div>
					</div>
				</div>
