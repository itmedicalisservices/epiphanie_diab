									...
									<?php foreach($listeAvisEncours AS $le){ ?>
										<tr>
											...
											<td class="text-center">
												<a href="javascript:;<?php echo site_url("cardiologie/consultation_avis/".$le->acm_id."/".$le->avs_id); ?>"><b><i class="fa fa-stethoscope" style="font-size:23px"></i><br>Consulter</b></a>
											</td>
										</tr>
									<?php } ?>
									</tbody>
