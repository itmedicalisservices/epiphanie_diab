...
<?php $listeNum = $this->md_budget->liste_compte_fonctionnement(); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left"><b>Charges de fonctionnement</b>/ Liste des libellés de comptes (<?php echo count($liste) ;?>)</h2><button style="" type="button" class="btn bg-blue-grey waves-effect ajout_service pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Nouveau</b></button>
                    </div>
						...
						<table class="table table-bordered table-striped table-hover " id="example">
							...
							<?php foreach($liste AS $l){ ?>
								<tr>
									...
									<td>
										<?php echo $l->fcp_sLibelle; ?>
									</td>									
									<td class="text-center">
										<a href="#<?php echo site_url("parametre/modifier_compte/".$l->cpt_id); ?>" class="" title="Modifier"><i class="zmdi zmdi-edit"></i></a>
										<a onClick="return confirm('Êtes-vous sûr de supprimer ce libellé de compte ?')" href="<?php echo site_url("parametre/supprimer_compte_fonctionnement/".$l->fcp_id); ?>" class="delete" title="Supprimer"><i class="zmdi zmdi-delete text-danger" style="font-size:20px"></i></a>
									</td>
								</tr>
							<?php } ?>
							</tbody>
    ...
    <div class="modal-dialog modal-lg" role="document" style="margin-top:20px; max-width:60%">
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height:500px; overflow:auto;">
				 ...
				 <div class="col-lg-12 col-md-12 col-sm-12">
					<div class="card">
						...
						<div class="body table-responsive">
							<div class="col-lg-12 col-md-12 col-sm-12 retour-fonctionnement"></div>
							<form id="form-fonctionnement">
            ...
            <div class="modal-footer">
                <a href="javascript:();" class="btn btn-success waves-effect addFoncCompte" style="color:#fff"><i class="fa fa-check"></i> Enregistrer</a>
