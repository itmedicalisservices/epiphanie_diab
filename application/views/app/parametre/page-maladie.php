...
<?php $listeFam = $this->md_parametre->liste_famille_maladie_actifs(); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">Classification des maladies par famille </h2><button style="" type="button" class="btn bg-blue-grey waves-effect ajout_service pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter</b></button>
                    ...
                    <div class="body table-responsive"> 
						<table class="table table-bordered table-striped table-hover " id="example">
							...
							<?php foreach($liste AS $l){ ?>
								<tr>
									<td>
										<span class="champs_dep<?php echo $l->mal_id ?>"><?php echo $l->fma_sLibelle; ?></span>
										<form id='form-edit_dep<?php echo $l->mal_id ?>'>
											<select class="cacher input_dep<?php echo $l->mal_id ?>" name="dep" style="width:100%;padding-bottom:10px;padding-top:10px">
												<?php foreach($listeFam AS $f){ ?>
												<option value="<?php echo $f->fma_id; ?>-/-<?php echo $f->fma_sLibelle; ?>" <?php if($f->fma_id == $l->fma_id){echo "selected='selected'";} ?>><?php echo $f->fma_sLibelle; ?></option>
												<?php } ?>
											</select>
										</form>
									</td>
										...
										<tr>
											<td>
												<select id="dep" style="width:100%;padding-bottom:5px;padding-top:5px">
													<option value="">----- Choisissez la famille * -----</option>
													<?php foreach($listeFam AS $f){ ?>
													<option value="<?php echo $f->fma_id; ?>-/-<?php echo $f->fma_sLibelle; ?>"><?php echo $f->fma_sLibelle; ?></option>
													<?php } ?>
												</select>
											</td>
											<td>
