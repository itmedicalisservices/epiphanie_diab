...
<?php $listeNum = $this->md_budget->liste_compte_investissements(); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left"><b>Charges d'investissement</b>/ Liste des libellés de comptes (<?php echo count($liste) ;?>)</h2><button style="" type="button" class="btn bg-blue-grey waves-effect ajout_service pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Nouveau</b></button>
                    </div>
    ...
    <div class="modal-dialog modal-lg" role="document" style="margin-top:20px; max-width:60%">
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height:500px; overflow:auto;">
				 ...
				 <div class="col-lg-12 col-md-12 col-sm-12">
					<div class="card">
						...
						<div class="body table-responsive">
							<div class="col-lg-12 col-md-12 col-sm-12 retour-sous-compte"></div>
							<form id="form-sous-compte">
            ...
            <div class="modal-footer">
                <a href="javascript:();" class="btn btn-success waves-effect addSousCompte" style="color:#fff"><i class="fa fa-check"></i> Enregistrer</a>
