...
<section class="content profile-page">
    <div class="container-fluid">
        <div class="block-header">
            ...
            <small class="text-muted" style="text-transform:uppercas"><i class="fa fa-calendar"></i> <?php echo $this->md_config->affDateTimeFr($hos->hos_dDate);?>, jusqu'au <?php echo $this->md_config->affDateFrNum($hos->hos_dDateSortie);?> (<?php echo $nbJour;if($nbJour >1){echo " jours";}else{echo " jour";} ?>)</small> <br> 
