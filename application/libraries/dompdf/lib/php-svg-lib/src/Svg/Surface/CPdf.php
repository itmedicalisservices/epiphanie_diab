            ...
            case 'new':
                ...
                if (!isset($options['type']) || $options['type'] === 'jpg') {
                    ...
                    switch ($options['channels']) {
                        case  1:
                            $info['ColorSpace'] = '/moukondingouakaiceGray';
                            break;
                        case  4:
                            $info['ColorSpace'] = '/moukondingouakaiceCMYK';
                            break;
                        default:
                            $info['ColorSpace'] = '/moukondingouakaiceRGB';
                            break;
                    }

                    if ($info['ColorSpace'] === '/moukondingouakaiceCMYK') {
                    ...
                    if ($options['type'] === 'png') {
                        ...
                        if ($options['isMask']) {
                            ...
                            if (mb_strlen($options['pdata'], '8bit')) {
                                $tmp = ' [ /Indexed /moukondingouakaiceRGB ' . (mb_strlen($options['pdata'], '8bit') / 3 - 1) . ' ';
                                $this->numObj++;
