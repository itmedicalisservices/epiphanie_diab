...
class Gynecologie extends CI_Controller {
	...
	{
		$this->load->view('app/gynecologie/page-liste-consultation');
	}
	...
	public function consultation_avis($id, $avs)
	{
		...
		$this->load->view('app/gynecologie/page-consultation',array("acm_id"=>$id,"avs"=>$avs));
	}
	
	public function demande_avis()
	{
		$this->load->view('app/gynecologie/page-liste-avis');
	}
	
	public function mes_patients()
	{
		$this->load->view('app/gynecologie/page-mes-patients');
	}
	
	public function hostirique_de_mes_patients()
	{
		$this->load->view('app/gynecologie/page-dossiers-patients');
	}
	
	public function hostorique_actes()
	{
		$this->load->view('app/gynecologie/page-hostorique-patients');
	}
	...
	public function faire($id)
	{
		...
		$this->md_patient->maj_actes_caisse($donneesAcm,$id);
		$this->load->view('app/gynecologie/page-consultation',array("acm_id"=>$id));
	}
	
	public function voir($id)
	{
		$this->load->view('app/gynecologie/page-rapport-consultation',array("acm_id"=>$id));
	}
	...
	public function recupExampelvien()
	{
		...
		if (empty($data)) {
			...
			if (!is_null($c->pee_sCalibrage)) {
				echo $c->pee_sCalibrage;
			} else {
				echo '<i><br>Non renseigné</i>';
			}
			echo '</label>
			...
			echo '<div class="post-box">
					...
					<div class="body p-l-0 p-r-0">
						<div class="row clearfix" style="margin-bottom:12px">	
							...
							<div class="col-sm-4">
								<label style="color:#000"><span>Sensibilité : </span>';
									if(!is_null($c->abe_sSensibilite)){echo $c->abe_sSensibilite ;}else{echo '<i><br>Non renseigné</i>';}
							echo '</label>
							</div>
				...
				echo '<div class="post-box">
					<h4>Douleurs abdomino-pelviennes</h4>
					<div class="body p-l-0 p-r-0">
						<div class="row clearfix" style="margin-bottom:12px">	
							<div class="col-sm-4">
								<label style="color:#000"><b>Localisation : </b>'; 
									if(!is_null($c->abe_sLocalisation)){echo $c->abe_sLocalisation;}else{echo '<i><br>Non renseignée</i>';} 
							echo '</label>
							</div>
							<div class="col-sm-4">
								<label style="color:#000"><b>Intensité : </b>';
									if(!is_null($c->abe_sIntensite)){echo $c->abe_sIntensite;}else{echo '<i><br>Non renseignée</i>';}
							echo '</label>
							</div>
							<div class="col-sm-4">
								<label style="color:#000"><b>Irradiation : </b>';
									if(!is_null($c->abe_sIrradiation)){echo $c->abe_sIrradiation;}else{echo '<i><br>Non renseigné</i>';}
							echo '</label>
							</div>
							<div class="col-sm-4">
								<label style="color:#000"><span>Défense : </span>';
									if(!is_null($c->abe_sDefence)){echo $c->abe_sDefence ;}else{echo '<i><br>Non renseigné</i>';}
							echo '</label>
							</div>
							<div class="col-sm-8">
								<label style="color:#000"><span>Contracture abdominale : </span>';
									if(!is_null($c->abe_sContracture)){echo $c->abe_sContracture ;}else{echo '<i><br>Non renseigné</i>';}
							echo '</label>
							</div>
		...
		if(empty($data)){
			...
			echo '<div class="post-box">
					...
					<div class="body p-l-0 p-r-0">
						<div class="row clearfix" style="margin-bottom:12px">	
							<div class="col-sm-6">
								<label style="color:#000"><b>Cloison recto-vaginale : </b>'; 
									if(!is_null($c->eva_sCloison_1)){echo $c->eva_sCloison_1;}else{echo '<i><br>Non renseignée</i>';} 
								echo '</label>
							</div>
							<div class="col-sm-6">
								<label style="color:#000"><b>Cloison vésico-vaginale : </b>';
									if(!is_null($c->eva_sCloison_2)){echo $c->eva_sCloison_2;}else{echo '<i><br>Non renseignée</i>';}
								echo '</label>
							</div>
							<div class="col-sm-6">
								<label style="color:#000"><b>Culs de sac vaginaux : </b>';
									if(!is_null($c->eva_sCul_1)){echo $c->eva_sCul_1;}else{echo '<i><br>Non renseignés</i>';}
								echo '</label>
							</div>
							<div class="col-sm-6">
								<label style="color:#000"><b>Cul de sac vaginal postérieur : </b>';
									if(!is_null($c->eva_sCul_2)){echo $c->eva_sCul_2 ;}else{echo '<i><br>Non renseigné</i>';}
								echo '</label>
							</div>
							<div class="col-sm-6">
								<label style="color:#000"><b>Nodule : </b>';
									if(!is_null($c->eva_sNodule)){echo $c->eva_sNodule ;}else{echo '<i><br>Non renseigné</i>';}
								echo '</label>
							</div>
				...
				echo '<div class="post-box">
						...
						<div class="body p-l-0 p-r-0">
							<div class="row clearfix" style="margin-bottom:12px">	
								<div class="col-sm-4">
									<label style="color:#000"><b>Forme : </b>'; 
									if(!is_null($c->eva_sForme)){echo $c->eva_sForme;}else{echo '<i><br>Non renseignée</i>';} 
									echo '</label>
								</div> 
								<div class="col-sm-4">
									<label style="color:#000"><b>Longueur : </b>';
										if(!is_null($c->eva_sLongueur)){echo $c->eva_sLongueur . ' mm';}else{echo '<i><br>Non renseignée</i>';}
									echo '</label>
								</div>
								<div class="col-sm-4">
									<label style="color:#000"><b>Volume : </b>';
										if(!is_null($c->eva_sVolume_1)){echo $c->eva_sVolume_1 . ' mm³';}else{echo '<i><br>Non renseigné</i>';}
									echo '</label>
								</div>
								<div class="col-sm-4">
									<label style="color:#000"><b>Ouverture : </b>';
										if(!is_null($c->eva_sOuver)){echo $c->eva_sOuver ;}else{echo '<i><br>Non renseignée</i>';}
									echo '</label>
								</div>
								<div class="col-sm-4">
									<label style="color:#000"><b>Consistance : </b>';
										if(!is_null($c->eva_sConsis_1)){echo $c->eva_sConsis_1 ;}else{echo '<i><br>Non renseignée</i>';}
									echo '</label>
								</div>
								<div class="col-sm-4">
									<label style="color:#000"><b>Mobilité : </b>';
										if(!is_null($c->eva_sMob_1)){echo $c->eva_sMob_1 ;}else{echo '<i><br>Non renseignée</i>';}
									echo '</label>
								</div>
								<div class="col-sm-4">
									<label style="color:#000"><b>Sensibilité : </b>';
										if(!is_null($c->eva_sSensis_1)){echo $c->eva_sSensis_1 ;}else{echo '<i><br>Non renseignée</i>';}
									echo '</label>
								</div>
					...
					echo '<div class="post-box">
						...
						<div class="body p-l-0 p-r-0">
							<div class="row clearfix" style="margin-bottom:12px">	
								<div class="col-sm-8">
									<label style="color:#000"><b>Position de l\'utérus : </b>'; 
									if(!is_null($c->eva_sPosis)){echo $c->eva_sPosis;}else{echo '<i><br>Non renseignée</i>';} 
									echo '</label>
								</div> 
								<div class="col-sm-4">
									<label style="color:#000"><b>Volume : </b>';
										if(!is_null($c->eva_sVolume_2)){echo $c->eva_sVolume_2 . ' mm³';}else{echo '<i><br>Non renseigné</i>';}
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>Consistance : </b>';
										if(!is_null($c->eva_sConsis_2)){echo $c->eva_sConsis_2 ;}else{echo '<i><br>Non renseignée</i>';}
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>Mobilité : </b>';
										if(!is_null($c->eva_sMob_2)){echo $c->eva_sMob_2 ;}else{echo '<i><br>Non renseignée</i>';}
									echo '</label>
								</div>
								<div class="col-sm-12">
									<label style="color:#000"><b>Sensibilité : </b>';
										if(!is_null($c->eva_sSensis_2)){echo $c->eva_sSensis_2 ;}else{echo '<i><br>Non renseignée</i>';}
									echo '</label>
								</div>
							</div>
						</div>
					...
					echo '<div class="post-box">
						...
						<div class="body p-l-0 p-r-0">
							<div class="row clearfix" style="margin-bottom:12px">	
								<div class="col-sm-8">
									<label style="color:#000"><b>Masse pelvienne : </b>'; 
									if(!is_null($c->eva_sMasse)){echo $c->eva_sMasse;}else{echo '<i><br>Non renseignée</i>';} 
									echo '</label>
								</div> 
								<div class="col-sm-4">
									<label style="color:#000"><b>Ovaires : </b>';
										if(!is_null($c->eva_sOvaire)){echo $c->eva_sOvaire ;}else{echo '<i><br>Non renseignés</i>';}
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>Plancher pelvien : </b>';
										if(!is_null($c->eva_sPelvien)){echo $c->eva_sPelvien ;}else{echo '<i><br>Non renseigné</i>';}
									echo '</label>
								</div>
							</div>
	...
	public function addExamEchographique()
	{
		...
		$data = $this->input->post();
			...
			$donnees = array(
					...
					"eec_sPrescripteur"=>$this->session->epiphanie_diab,
	...
	public function recupExamEcho()
	{
		...
		if (empty($data)) {
			...
			echo '<div class="post-box">
						...
						<h4 style="font-size:17px;">Echographique gynécologique</h4>
						<div class="body p-l-0 p-r-0">
							<div class="row clearfix" style="margin-bottom:12px">	
								<div class="col-sm-6">
									<h5 style="font-size:15px;">Renseignements généraux</h5>
									<label style="color:#000"><b>Date du début des règles: </b>';
										if (!is_null($c->eec_sDdr)) { echo $this->md_config->dateEN2FR($c->eec_sDdr); } else {echo '<i><br>Non renseignée</i>';}
									echo '</label>
								</div>
								<div class="col-sm-6">
									<h5 style="font-size:15px;">Indications</h5>
									<label style="color:#000"><b>Utérus: </b>';
										if (!is_null($c->eec_sUterus)) { echo $c->eec_sUterus; } else { echo '<i><br>Non renseignée</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>Contexte gynécologique: </b>';
										if (!is_null($c->eec_sContexte)) { echo $c->eec_sContexte; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>Annexes: </b>';
										if (!is_null($c->eec_sAnnexe)) { echo $c->eec_sAnnexe; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>Conditions de réalisation: </b>';
										if (!is_null($c->eec_sRealisation)) { echo $c->eec_sRealisation; } else { echo '<i><br>Non renseigné</i>';}
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>Autres: </b>';
										if (!is_null($c->eec_sAutres)) { echo $c->eec_sAutres; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>Voie d\'examen: </b>';
										if (!is_null($c->eec_sExamen)) { echo $c->eec_sExamen; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>indication - texte libre: </b>';
										if (!is_null($c->eec_sTexte)) { echo $c->eec_sTexte; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
							</div>
							<a href="'.site_url("impression/examen_echographique_1/". $c->sea_id) . '" class="text-success" title="Imprimer" ><i class="fa fa-print pull-right" style="font-size:25px"></i></a>
						</div>
				</div> <hr>';


			echo '<div class="post-box">
						<h4 style="font-size:17px;">Utérus</h4>
						<div class="body p-l-0 p-r-0">
							<div class="row clearfix" style="margin-bottom:12px">	
								<div class="col-sm-3">
									<h5 style="font-size:15px;">Dimensions</h5>
									<label style="color:#000"><b>Longueur: </b>';
										if (!is_null($c->eec_iLongueur)) {echo $c->eec_iLongueur . ' mm'; } else { echo '<i><br>Non renseignée</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<h5 style="font-size:15px;">Anatomie</h5>
									<label style="color:#000"><b>Position:  </b>';
										if (!is_null($c->eec_sUterus)) { echo $c->eec_sUterus; } else { echo '<i><br>Non renseignée</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<h5 style="font-size:15px;">Endomètre</h5>
									<label style="color:#000"><b></b>';
										if (!is_null($c->eec_sEndometre)) { echo $c->eec_sEndometre; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<h5 style="font-size:15px;">Cavité</h5>
									<label style="color:#000"></b>';
										if (!is_null($c->eec_sCavite)) { echo $c->eec_sCavite; } else { echo '<i><br>Non renseignée</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<label style="color:#000">Largeur: </b>';
										if (!is_null($c->eec_iLargeur)) { echo $c->eec_iLargeur . ' mm'; } else { echo '<i><br>Non renseignée</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<label style="color:#000">Contours: </b>';
										if (!is_null($c->eec_sContour)) { echo $c->eec_sContour; } else { echo '<i><br>Non renseignés</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<label style="color:#000">Epaisseur: </b>';
										if (!is_null($c->eec_iEpaisseur)) { echo $c->eec_iEpaisseur . ' mm'; } else { echo '<i><br>Non renseignée</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<label style="color:#000">DIU: </b>';
										if (!is_null($c->eec_sDiu)) { echo $c->eec_sDiu; } else { echo '<i><br>Non renseignés</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<label style="color:#000">Hauteur: </b>';
										if (!is_null($c->eec_iHauteur)) { echo $c->eec_iHauteur . ' mm'; } else { echo '<i><br>Non renseignés</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<label style="color:#000">Structure myomètre: </b>';
										if (!is_null($c->eec_sMyometre)) { echo $c->eec_sMyometre; } else { echo '<i><br>Non renseignés</i>'; }
									echo '</label>
								</div>
							</div>
							<a href="'.site_url("impression/examen_echographique_2/". $c->sea_id).'" class="text-success" title="Imprimer" ><i class="fa fa-print pull-right" style="font-size:25px"></i></a>
						</div>
				</div><hr>';

			echo '<div class="post-box">
						<h4 style="font-size:17px;">Autres</h4>
						<div class="body p-l-0 p-r-0">
							<div class="row clearfix" style="margin-bottom:12px">	
								<div class="col-sm-3">
									<h5 style="font-size:15px;">Ovaires</h5>
									<label style="color:#000"><b>Ovaire droit: </b>';
										if (!is_null($c->eec_sOvaireDroit)) { echo $c->eec_sOvaireDroit; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<h5 style="font-size:15px;">Culs de sac</h5>
									<label style="color:#000"><b>Culs de sac latéraux:  </b>';
										if (!is_null($c->eec_sCul)) { echo $c->eec_sCul; } else { echo '<i><br>Non renseignés</i>';}
									echo '</label>
								</div>
								<div class="col-sm-3">
									<h5 style="font-size:15px;">Doppler A. utérines</h5>
									<label style="color:#000"><b>AUD IR: </b>';
										if (!is_null($c->eec_sAudir)) { echo $c->eec_sAudir; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<h5 style="font-size:15px;">Trompes</h5>
									<label style="color:#000"><b>Description: </b>';
										if (!is_null($c->eec_sTrompes)) { echo $c->eec_sTrompes; } else { echo '<i><br>Non renseignée</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<label style="color:#000"><b>Grand axe ovaire droit: </b>';
										if (!is_null($c->eec_sOvaireDroitGrand)) { echo $c->eec_sOvaireDroitGrand . ' mm'; } else { echo '<i><br>Non renseignée</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<label style="color:#000"><b>Douglas: </b>';
										if (!is_null($c->eec_sDouglas)) { echo $c->eec_sDouglas; } else { echo '<i><br>Non renseignés</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-3">
									<label style="color:#000"><b>AUD IP: </b>';
										if (!is_null($c->eec_sAudip)) { echo $c->eec_sAudip; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>Ovaire gauche: </b>';
										if (!is_null($c->eec_sOvaireGauche)) { echo $c->eec_sOvaireGauche; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>AUG IR: </b>';
										if (!is_null($c->eec_sAugir)) { echo $c->eec_sAugir; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>Grand axe ovaire gauche: </b>';
										if (!is_null($c->eec_sOvaireGaucheGrand)) { echo $c->eec_sOvaireGaucheGrand . ' mm'; } else { echo '<i><br>Non renseignés</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>AUG IP: </b>';
										if (!is_null($c->eec_sAugip)) { echo $c->eec_sAugip; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-12" style="margin-top:10px;">
									<label style="color:#000"><b>Conclusion: </b>';
										if (!is_null($c->eec_sConclusion)) { echo $c->eec_sConclusion; } else { echo '<i><br>Non renseignée</i>'; }
									echo '</label>
								</div>
							</div>
							<a href="'.site_url("impression/examen_echographique_3/".$c->sea_id).'" class="text-success" title="Imprimer" ><i class="fa fa-print pull-right" style="font-size:25px"></i></a>
						</div>
				</div>';
		}
	}

	public function addExamSenologique()
	{
		date_default_timezone_set('Africa/Brazzaville');
		$data = $this->input->post();
		...
		$donnees = array(
			...
			"pat_id" => $data['pat_soins'],
			"sea_id" => $sejour->sea_id,
			"ese_sAnomalieCutanee" => $data['champs_1'],
			"ese_sPrescripteur" => $this->session->epiphanie_diab,
			"ese_sDissymetries" => $data['champs_2'],
			"ese_sAnomaliesAreole" => $data['champs_3'],
			"ese_sPalpationNodules_1" => $data['champs_4'],
			"ese_sPalpationNodules_2" => $data['champs_5'],
			"ese_sPalpationNodules_3" => $data['champs_6'],
			"ese_iDistanceMamelonnaire" => $data['champs_7'],
			"ese_iTaille" => $data['champs_8'],
			"ese_sSensibilite" => $data['champs_9'],
			"ese_sMobilite" => $data['champs_10'],
			"ese_sEvolutionTumeur" => $data['champs_11'],
			"ese_sForme_1" => $data['champs_12'],
			"ese_sForme_2" => $data['champs_13'],
			"ese_sForme_3" => $data['champs_14'],
			"ese_sForme_4" => $data['champs_15'],
			"ese_sConsistance_1" => $data['champs_16'],
			"ese_sConsistance_2" => $data['champs_17'],
			"ese_sConsistance_3" => $data['champs_18'],
			"ese_sConsistance_4" => $data['champs_19'],
			"ese_sExpression" => $data['champs_20'],
			"ese_iVolume" => $data['champs_21'],
			"ese_sConsistance" => $data['champs_22'],
			"ese_sEcoulement_1" => $data['champs_23'],
			"ese_sEcoulement_2" => $data['champs_24'],
			"ese_sEcoulement_3" => $data['champs_25'],
			"ese_sEcoulement_4" => $data['champs_26'],
			"ese_sCouleur" => $data['champs_27'],
			"ese_dDate" => $aujourdhui
		);
		$insert = $this->md_patient->new_examen_senologique($donnees);

		echo $data["id"];
	}

	public function recupExamSenologique()
	{
		date_default_timezone_set('Africa/Brazzaville');
		$data = $this->input->post();
		if (empty($data)) {
			...
			$c = $this->md_patient->examen_senologique($data["id"]);
			echo '<div class="post-box">
						<h3>Examen Sénologique <small class="text-success pull-right" style="font-size:14px"><i class="fa fa-calendar"></i> Fait ' . $this->md_config->affDateTimeFr($c->ese_dDate) . '</small></h3>
						<div class="body p-l-0 p-r-0">
							<h5 style="font-size:15px;">Inspection</h5>
							<div class="row clearfix" style="margin-bottom:12px">
								<div class="col-sm-4">
									<label style="color:#000"><b>Anomalies cutannées: </b>';
										if (!is_null($c->ese_sAnomalieCutanee)) { echo $c->ese_sAnomalieCutanee; } else { echo '<i><br>Non renseignée</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-4">
									<label style="color:#000"><b>Dissymétries: </b>';
										if (!is_null($c->ese_sDissymetries)) { echo $c->ese_sDissymetries; } else { echo '<i><br>Non renseignée</i>'; }
									echo '</label>
								</div>
								
								<div class="col-sm-4">
									<label style="color:#000"><b>Anomalie de l\'aréole: </b>';
										if (!is_null($c->ese_sAnomaliesAreole)) { echo $c->ese_sAnomaliesAreole; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								
								<div class="col-sm-12"><h5 style="font-size:15px;">Palpation des nodules</h5></div>
								<div class="col-sm-4">
									<label style="color:#000"><b></b>';
										if (!is_null($c->ese_sPalpationNodules_1)) { echo $c->ese_sPalpationNodules_1; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-4">
									<label style="color:#000"><b></b>';
										if (!is_null($c->ese_sPalpationNodules_2)) { echo $c->ese_sPalpationNodules_2; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-4">
									<label style="color:#000"><b></b>';
										if (!is_null($c->ese_sPalpationNodules_3)) { echo $c->ese_sPalpationNodules_3; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-4">
									<label style="color:#000"><b>Distance mamelonnaire: </b>';
										if (!is_null($c->ese_iDistanceMamelonnaire)) { echo $c->ese_iDistanceMamelonnaire; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-4">
									<label style="color:#000"><b>Taille: </b>';
										if (!is_null($c->ese_iTaille)) { echo $c->ese_iTaille . ' cm'; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-4">
									<label style="color:#000"><b>Sensibilité : </b>';
										if (!is_null($c->ese_sSensibilite)) { echo $c->ese_sSensibilite; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>Mobilité : </b>';
										if (!is_null($c->ese_sMobilite)) { echo $c->ese_sMobilite; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b>Evolution de la tumeur : </b>';
										if (!is_null($c->ese_sEvolutionTumeur)) { echo $c->ese_sEvolutionTumeur; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								
								<div class="col-sm-6">
									<h5 style="font-size:15px;"><b>Forme</b></h5>
									<label style="color:#000"><b></b>';
										if (!is_null($c->ese_sForme_1)) { echo $c->ese_sForme_1; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								
								<div class="col-sm-6">
									<h5 style="font-size:15px;"><b>Consistance</b></h5>
									<label style="color:#000">';
										if (!is_null($c->ese_sConsistance_1)) { echo $c->ese_sConsistance_1; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b></b>';
										if (!is_null($c->ese_sForme_2)) { echo $c->ese_sForme_2; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b></b>';
										if (!is_null($c->ese_sConsistance_2)) { echo $c->ese_sConsistance_2; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b></b>';
										if (!is_null($c->ese_sForme_3)) { echo $c->ese_sForme_3; } else { echo '<i><br>Non renseigné</i>'; } echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b></b>';
										if (!is_null($c->ese_sConsistance_3)) { echo $c->ese_sConsistance_3; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b></b>';
										if (!is_null($c->ese_sForme_4)) { echo $c->ese_sForme_4; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<label style="color:#000"><b></b>';
										if (!is_null($c->ese_sConsistance_4)) { echo $c->ese_sConsistance_4; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-12"><h5 style="font-size:15px;">Ecoulement mamaire</h5></div>
								<div class="col-sm-4">
									<label style="color:#000"><b>Expression du mamelon entre pouce et index: </b>';
										if (!is_null($c->ese_sExpression)) { echo $c->ese_sExpression; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-4">
									<label style="color:#000"><b>Volume: </b>';
										if (!is_null($c->ese_iVolume)) { echo $c->ese_iVolume; } else { echo '<i><br>Non renseigné</i>';}
									echo '</label>
								</div>
								<div class="col-sm-4">
									<label style="color:#000"><b>Consistance: </b>';
										if (!is_null($c->ese_sConsistance)) { echo $c->ese_sConsistance; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<h5 style="font-size:15px;"><b>Ecoulement</b></h5>
									<label style="color:#000">';
										if (!is_null($c->ese_sEcoulement_1)) { echo $c->ese_sEcoulement_1; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-6">
									<h5 style="font-size:15px;"><b>Couleur</b></h5>
									<label style="color:#000">';
										if (!is_null($c->ese_sCouleur)) { echo $c->ese_sCouleur; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-12">
									<label style="color:#000">';
										if (!is_null($c->ese_sEcoulement_2)) { echo $c->ese_sEcoulement_2; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-12">
									<label style="color:#000">';
										if (!is_null($c->ese_sEcoulement_3)) { echo $c->ese_sEcoulement_3; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
								<div class="col-sm-12">
									<label style="color:#000">';
										if (!is_null($c->ese_sEcoulement_4)) { echo $c->ese_sEcoulement_4; } else { echo '<i><br>Non renseigné</i>'; }
									echo '</label>
								</div>
							</div>
							<a href="'.site_url("impression/examen_senologique/".$c->sea_id).'"class="text-success" title="Imprimer" ><i class="fa fa-print pull-right" style="font-size:25px"></i></a>
						</div>
				</div>';
		}
	}
			...
			$c = $this->md_patient->examen_echographique($data["id"]);
				...
				echo '<div class="post-box">
						...
						<div class="body p-l-0 p-r-0">
							...
							<a href="'.site_url("impression/examen_echographique/".$c->sea_id).'" class="text-success" title="Imprimer" ><i class="fa fa-print pull-right" style="font-size:25px"></i></a>
						</div>
				</div>';
	...
	public function reponse_avis(){
		...
		$data = $this->input->post();
		if(!isset($data)){
			return redirect("gynecologie/consultation_avis");
		}
		else{
			$donnees = array(
				"avs_iSta"=>2,
			...
			return redirect("gynecologie/demande_avis");
		}
	}
