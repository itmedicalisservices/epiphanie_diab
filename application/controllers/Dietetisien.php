...
class Dietetisien extends CI_Controller {
	...
	{
		$this->load->view('app/dietetisien/page-liste-consultation');
	}
	
	public function mes_patients()
	{
		$this->load->view('app/dietetisien/page-mes-patients');
	}
	
	public function hostirique_de_mes_patients()
	{
		$this->load->view('app/dietetisien/page-dossiers-patients');
	}
	
	public function hostorique_actes()
	{
		$this->load->view('app/dietetisien/page-hostorique-patients');
	}
	...
	public function faire($id)
	{
		...
		$this->load->view('app/dietetisien/page-consultation',array("acm_id"=>$id));
	}
	
	public function voir($id)
	{
		$this->load->view('app/dietetisien/page-rapport-consultation',array("acm_id"=>$id));
	}
