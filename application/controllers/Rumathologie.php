...
class Rumathologie extends CI_Controller {
	...
	{
		$this->load->view('app/rumathologie/page-liste-consultation');
	}
	...
	public function consultation_avis($id, $avs)
	{
		...
		$this->load->view('app/rumathologie/page-consultation',array("acm_id"=>$id,"avs"=>$avs));
	}
	
	public function demande_avis()
	{
		$this->load->view('app/rumathologie/page-liste-avis');
	}
	
	public function mes_patients()
	{
		$this->load->view('app/rumathologie/page-mes-patients');
	}
	
	public function hostirique_de_mes_patients()
	{
		$this->load->view('app/rumathologie/page-dossiers-patients');
	}
	
	public function hostorique_actes()
	{
		$this->load->view('app/rumathologie/page-hostorique-patients');
	}
	...
	public function faire($id)
	{
		...
		$this->md_patient->maj_actes_caisse($donneesAcm,$id);
		$this->load->view('app/rumathologie/page-consultation',array("acm_id"=>$id));
	}
	
	public function voir($id)
	{
		$this->load->view('app/rumathologie/page-rapport-consultation',array("acm_id"=>$id));
	}
	...
	public function reponse_avis(){
		...
		$data = $this->input->post();
		if(!isset($data)){
			return redirect("rumathologie/consultation_avis");
		}
		else{
			$donnees = array(
				"avs_iSta"=>2,
			...
			return redirect("rumathologie/demande_avis");
		}
	}
