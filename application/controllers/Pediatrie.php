...
class pediatrie extends CI_Controller {
	...
	{
		$this->load->view('app/pediatrie/page-liste-consultation');
	}
	
	public function mes_patients()
	{
		$this->load->view('app/pediatrie/page-mes-patients');
	}
	
	public function hostirique_de_mes_patients()
	{
		$this->load->view('app/pediatrie/page-dossiers-patients');
	}
	
	public function hostorique_actes()
	{
		$this->load->view('app/pediatrie/page-hostorique-patients');
	}
	...
	public function faire($id)
	{
		...
		$this->load->view('app/pediatrie/page-consultation',array("acm_id"=>$id));
	}
	
	public function voir($id)
	{
		$this->load->view('app/pediatrie/page-rapport-consultation',array("acm_id"=>$id));
	}
